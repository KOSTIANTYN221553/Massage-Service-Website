...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        <!--section starts-->
        <h1><?php echo e(__('lang.유저갤러리')); ?></h1>
    </section>
    <!--section ends-->
            ...
            <div class="col-lg-12">
                <div class="panel panel-primary filterable">
                    ...
                    <div class="panel-body ">
                        <form id = "searchFrm" action = "<?php echo e(url("admin/user_board")); ?>" method = "post">
                            ...
                            <table class="table table-bordered table-striped  table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class = "sorting" aria-name = "id"><?php echo e(__('lang.이미지')); ?></th>
                                ...
                                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class  ="cursor" onclick = "viewDetail(this)" data-id = "<?php echo e($item['id']); ?>">
                                            <img onerror = "noExitImg(this)" src ="<?php echo e(correctImgPath($item['user']['photo_url'])); ?>" class = "wh-80"/>
                                        </td>
                                        ...
                                        <td>
                                            <a class = "btn btn-danger" href = "<?php echo e(url("admin/user_board/info/".$item['id'])); ?>"><?php echo e(__('lang.수정')); ?></a>
                                        </td>
                                    </tr>
                        ...
                        <div class = "table-responsive">
                            <div class = "col-md-12 text-left">
                                ...
                                <a type = "button" class = "btn btn-primary float-right" href = "<?php echo e(url('admin/user_board/info/0')); ?>"><i class = "fa fa-plus"></i><?php echo e(__('lang.글쓰기')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->startSection('footer_scripts'); ?>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/pages/admin/user_board.js')); ?>" ></script>
    <script>
        function viewDetail(obj){
            var id = $(obj).attr("data-id");
            var url = "<?php echo e(url('admin/user_board/view')); ?>/"+id;
            loading_start();
