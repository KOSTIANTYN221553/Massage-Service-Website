                    ...
                    <div class="panel-heading clearfix  ">
                        <div class="panel-title pull-left">
                            <div class="caption">
                                ...
                                <?php echo e(__('lang.업소종류리스트')); ?>

                            </div>
                        </div>
                    </div>
                    <div class="panel-body ">
                        <form id = "searchFrm" action = "<?php echo e(url("admin/shop_type")); ?>" method = "post">
                            ...
                            <table class="table table-bordered table-striped  table-hover">
                                ...
                                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class = "btn btn-danger" href = "<?php echo e(url("admin/shop_type/info/".$item['id'])); ?>"><?php echo e(__('lang.수정')); ?></a>
                                        </td>
                                    </tr>
                        ...
                        <div class = "table-responsive">
                            <div class = "col-md-12 text-left">
                                ...
                                <a type = "button" class = "btn btn-primary float-right" href = "<?php echo e(url('admin/shop_type/info/0')); ?>"><i class = "fa fa-plus"></i><?php echo e(__('lang.업소종류생성')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->startSection('footer_scripts'); ?>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/pages/admin/shop_type.js')); ?>" ></script>
    <script>
        $(function(){
           <?php if(isset($notice_info)): ?>
