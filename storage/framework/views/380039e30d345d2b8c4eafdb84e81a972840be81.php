...
<script src="<?php echo e(url('assets/mobiscroll/js/mobiscroll/mobiscroll.custom-2.17.1.min.js')); ?>" type="text/javascript"></script>
...
<script src="<?php echo e(url('assets/datepicker/bootstrap-datepicker.js')); ?>"></script>
...
<script  src="<?php echo e(asset('assets/vendors/ckeditor/js1/jquery.js')); ?>"  type="text/javascript" ></script>
<script  src="<?php echo e(asset('assets/vendors/ckeditor/js/config.js')); ?>"  type="text/javascript"></script>
<script  src="<?php echo e(asset('assets/vendors/ckeditor/js1/plugins/placeholder/plugin.js')); ?>"  type="text/javascript"></script>
...
<script src="<?php echo e(asset('assets/crop/cropper.js')); ?>" ></script>
