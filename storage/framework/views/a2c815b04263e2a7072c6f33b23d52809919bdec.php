            ...
            <div class="col-lg-12">
                <div class="panel panel-primary filterable">
                    ...
                    <div class="panel-body ">
                        <form id = "searchFrm" action = "<?php echo e(url("admin/shop_question")); ?>" method = "post">
                            ...
                            <table class="table table-bordered table-striped  table-hover">
                                ...
                                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class  ="cursor" onclick = "viewDetail(this)" data-id = "<?php echo e($item['id']); ?>"><?php echo e(utf8_strcut(strip_tags($item['content']), 30)); ?></td>
                                        <td class = "cursor" onclick = "viewDetail(this)" data-id = "<?php echo e($item['id']); ?>"><?php echo e(getQuestionStatusStr($item['status'])); ?></td>
                                        <td>
                                            <a class = "btn btn-info" href = "<?php echo e(url("admin/shop_question/view/".$item['id'])); ?>"><?php echo e(__('lang.보기')); ?></a>
                                            <a class = "btn btn-danger" href = "<?php echo e(url("admin/shop_question/info/".$item['id'])); ?>"><?php if($is_admin==1): ?><?php echo e(__('lang.답변')); ?> <?php else: ?> <?php echo e(__('lang.수정')); ?> <?php endif; ?></a>
                                        </td>
                                    </tr>
                        ...
                        <div class = "table-responsive">
                            <div class = "col-md-12 text-left">
                                ...
                                <a type = "button" class = "btn btn-primary float-right" href = "<?php echo e(url('admin/shop_question/info/0')); ?>"><i class = "fa fa-plus"></i><?php echo e(__('lang.글쓰기')); ?></a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startSection('footer_scripts'); ?>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/pages/admin/shop_question.js')); ?>" ></script>
    <script>
        function viewDetail(obj){
            var id = $(obj).attr("data-id");
            var url = "<?php echo e(url('admin/shop_question/view')); ?>/"+id;
            loading_start();
