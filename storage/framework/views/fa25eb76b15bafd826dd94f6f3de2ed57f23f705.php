    ...
    <div class="container mt-10 ">
        ...
        <?php if(isset($notice_list)): ?>
            <?php $__currentLoopData = $notice_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href = "<?php echo e(url('/user_board/info/'.$item['id'])); ?>">
            ...
            <div class = "col-md-9 col-xs-12 mt-10">
                    ...
                    <div class="col-md-3 col-sm-5 profile">
                        <div class="thumbnail relative">
                            <?php if(Sentinel::check() && ($user_info['type']*1 == 99 || $user_info['id']*1 == $item['user']['id']*1) ): ?>
                                ...
                                <a class = "board-write hidden" href = "<?php echo e(url('user_board/write/'.$item['id'])); ?>" ><i class = "fa fa-pencil"></i></a>
                            <?php endif; ?>
                            <a href = "<?php echo e(url('/user_board/info/'.$item['id'])); ?>">
                                <img src="<?php echo e(correctImgPath($item['img'])); ?>" alt="team-image " class="img-responsive same-img" onerror="noExitImg(this)">
                            </a>
                            <div class="caption color-white">
                                <b class = "color-white">
                                    <img onerror = "noExitImg(this)" style="width:20px !important;" src="<?php echo e(url($item['level_icon'])); ?>" <?php if(isset($user['id']) && $item['user']['id']*1 != $user['id']*1): ?> onclick = "menuItemClick1(this)" <?php else: ?>  onclick = "userOnlyWrite(this)" <?php endif; ?> data-user-id ="<?php echo e($item['user_id']); ?>">
                                    <span class = "cursor" <?php if(isset($user['id']) && $item['user']['id']*1 != $user['id']*1): ?> onclick = "menuItemClick1(this)" <?php else: ?>  onclick = "userOnlyWrite(this)" <?php endif; ?> data-user-id ="<?php echo e($item['user_id']); ?>"><?php echo e($item['user']['nickname']); ?></span>
                                ...
                                <div class="divide">
                                    <div class = "row mt-10">
                                        <div class = "col-md-6 col-xs-6">
                                            <a href="<?php echo e(url('/user_board/info/'.$item['id'])); ?>" class="divider">
                ...
                <div class = "row">
                    <div class = "col-md-8 text-left col-xs-12">
                        <form id = "searchForm" action = "<?php echo e(url('user_board')); ?>" method = "post">
                    ...
                    <div class = "col-md-4 text-right mt-10 col-xs-12" style = "margin-top:17px;">
                        <?php if(Sentinel::check()): ?>
                            <a class = "color-white write-a btn-danger border-none"  href = "<?php echo e(url("user_board/write/0")); ?>"><?php echo e(__('lang.글쓰기')); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        function  delItem(obj){
            ...
            confirmMsg("<?php echo e(__('lang.정말 삭제하겟습니까?')); ?>", function(){
                setTimeout(function(){
                    ...
                    param._token = _token;
                    param.id = id;
                    var url = "<?php echo e(url("/user_board/deleteInfo")); ?>";
                    loading_start();
