            ...
            <div class="col-md-12">
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form  id = "infoForm" action = "<?php echo e(url("admin/board/ajaxSaveInfo")); ?>" method = "post">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="name"><?php echo e(__('lang.타입')); ?></label>
                                <select class = "form-control" name = "board_type">
                                    <?php $__currentLoopData = $board_type_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $board): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value = "<?php echo e($key); ?>" <?php if($key *1 == $info['board_type']*1 ): ?> selected <?php endif; ?>><?php echo e($board); ?></option>
                    ...
                    success: function (data) {
                        if (data.status == '1') {
                            successMsg("<?php echo e(__('lang.수정이 성공하였습니다.')); ?>", function(){
                               ...
                               if(id == "0"){
                                   window.location.href = "<?php echo e(url('admin/board')); ?>";
                               }else{
                                   goBack();
                               }
