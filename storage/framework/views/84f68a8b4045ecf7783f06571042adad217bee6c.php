    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-danger"><?php echo e(__('lang.알림')); ?></h4>
            </div>
            <form class="form-horizontal" id = "" method = "post" action="javascript:void(0)">
                <div class="modal-body" >
                    <p class = "text-danger"><?php echo e(__('lang.업소 갱신 1주일 남았습니다')); ?></p>
                </div>
                <div class="modal-footer">
                    <button type="button"  class="btn btn-primary" onclick = "closeIsOverDlg()" ><?php echo e(__('lang.확인')); ?></button>
                </div>
            </form>
        </div>
    </div>
