...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        <!--section starts-->
        <h1><?php echo e(__('lang.게시판관리')); ?></h1>
    </section>
    <!--section ends-->
            ...
            <div class="col-lg-12">
                <div class="panel panel-primary filterable">
                    ...
                    <div class="panel-body ">
                        <form id = "searchFrm" action = "<?php echo e(url("admin/board")); ?>" method = "post">
                            ...
                            <div class="page_section_1 page_section search_section" id="search_filter_layout">
                                ...
                                <div class="col-md-6">
                                    <div class = "row">
                                        <div class = "col-md-4">
                                            <select class="form-control" data-width="120px"  name = "board_type">
                                                <option value="0"><?php echo e(__('lang.전체')); ?></option>
                                                <?php $__currentLoopData = $board_type_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$board): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value = "<?php echo e($board['id']); ?>" <?php if($board['id']*1 == $board_type*1): ?> selected <?php endif; ?>><?php echo e($board['title']); ?></option>
                            ...
                            <table class="table table-bordered table-striped  table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class = "sorting" aria-name = "id"><?php echo e(__('lang.타입')); ?></th>
                                ...
                                <?php $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class  ="cursor" onclick = "viewDetail(this)" data-id = "<?php echo e($item['id']); ?>"><?php echo e($item['boardType']); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a class = "btn btn-danger" href = "<?php echo e(url("admin/board/info/".$item['id'])); ?>"><?php echo e(__('lang.수정')); ?></a>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class = "table-responsive">
                            <div class = "col-md-12 text-left">
                                ...
                                <a type = "button" class = "btn btn-primary float-right" href = "<?php echo e(url('admin/board/info/0')); ?>"><i class = "fa fa-plus"></i><?php echo e(__('lang.글쓰기')); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->startSection('footer_scripts'); ?>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/pages/admin/board.js')); ?>" ></script>
    <script>
        function viewDetail(obj){
            var id = $(obj).attr("data-id");
            var url = "<?php echo e(url('admin/board/view')); ?>/"+id;
