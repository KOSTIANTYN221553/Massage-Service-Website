...
<?php $__env->startSection('title'); ?>
    <?php if($id*1 == 0): ?> <?php echo e(__('lang.업소종류생성')); ?> <?php else: ?> <?php echo e(__('lang.업소종류수정')); ?> <?php endif; ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="content-header">
        <h1><?php if($id*1 == 0): ?> <?php echo e(__('lang.업소종류생성')); ?> <?php else: ?> <?php echo e(__('lang.업소종류수정')); ?> <?php endif; ?></h1>
    </section>
    <!--section ends-->
            ...
            <div class="col-md-12">
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form  id = "infoForm" action = "<?php echo e(url("admin/shop_type/ajaxSaveInfo")); ?>" method = "post">
                            <input type = "hidden" name = "_token" value = "<?php echo e(csrf_token()); ?>"/>
                            <input type = "hidden" name = "id" value = "<?php echo e($id); ?>"/>
                            <div class="form-group">
                                <label class="control-label" for="name"><?php echo e(__('lang.이름')); ?></label>
                                <input id="name" name="title" type="text" placeholder="이름을 입력해주세요." class="form-control" value = "<?php echo e($info['title']); ?>">
                            </div>
                            <div class="form-group">
