...
if(typeof(jQuery) != "undefined") {
    (function (a) {
        a.widget && (a.widget("mobile.jqmMobiscroll", a.mobile.widget, {
            options: {
                ...
                var b = this.element, l = a.extend(this.options, b.jqmData("options"));
                b.mobiscroll(l)
            }
        }), a(document).on("pagecreate", function (b) {
    ...
    (function (a, b) {
        ...
        function k(c, d, g) {
            var y = c;
            if ("object" === typeof d) return c.each(function () {1505
                i[this.id] && i[this.id].destroy();
                new a.mobiscroll.classes[d.component || "Scroller"](this, d)
            });
            "string" === typeof d && c.each(function () {
                var a;
                if ((a = i[this.id]) && a[d]) if (a = a[d].apply(this, Array.prototype.slice.call(g, 1)), a !== b) return y = a, !1
            });
            return y
        }
        ...
        var j, f = +new Date, i = {}, s = a.extend, q = document.createElement("modernizr").style,
            d = l(["perspectiveProperty", "WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"]),
            g = l(["flex", "msFlex", "WebkitBoxDirection"]), O = function () {
        ...
        j = a.mobiscroll = a.mobiscroll || {
            ...
            util: {
                ...
                getCoord: function (a, b, c) {
                    var d = a.originalEvent || a, b = (c ? "page" : "client") + b;
                    return d.changedTouches ? d.changedTouches[0][b] : a[b]
                },
                getPosition: function (c, g) {
                    var i = window.getComputedStyle ? getComputedStyle(c[0]) : c[0].style, f, k;
                    d ? (a.each(["t", "webkitT", "MozT", "OT", "msT"], function (a, c) {
                        if (i[c + "ransform"] !== b) return f = i[c + "ransform"], !1
                    }), f = f.split(")")[0].split(", "),
                        k = g ? f[13] || f[5] : f[12] || f[4]) : k = g ? i.top.replace("px", "") : i.left.replace("px", "");
                    return k
                },
                addIcon: function (c, b) {
                    var d = {}, g = c.parent(), f = g.find(".mbsc-err-msg"), i = c.attr("data-icon-align") || "left",
                        k = c.attr("data-icon");
                    a('<span class="mbsc-input-wrap"></span>').insertAfter(c).append(c);
                    f && g.find(".mbsc-input-wrap").append(f);
                    k && (-1 !== k.indexOf("{") ? d = JSON.parse(k) : d[i] = k, s(d, b), g.addClass((d.right ? "mbsc-ic-right " : "") + (d.left ? " mbsc-ic-left" : "")).find(".mbsc-input-wrap").append(d.left ? '<span class="mbsc-input-ic mbsc-left-ic mbsc-ic mbsc-ic-' +
            ...
            presetShort: function (a, c, d) {
                this.components[a] = function (g) {
                    return k(this, s(g, {component: c, preset: !1 === d ? b : a}), arguments)
                }
            }
        };
        a.mobiscroll.classes.Base = function (c, b) {
            var d, g, k, m, p, e, j = a.mobiscroll, l = j.util, H = l.getCoord, o = this;
            o.settings = {};
            ...
            o._init = function (a) {
                ...
                s(k, m, d, e, b);
                if (o._hasPreset && (o._presetLoad(k), g = j.presets[o._class][k.preset])) g = g.call(c, o), s(k, g, b)
            };
            o._destroy = function () {
                o.trigger("onDestroy", []);
                delete i[c.id];
            ...
            o.tap = function (c, b, d) {
                ...
                function g(a) {
                    if (n && !m && 9 < Math.abs(H(a, "X") - f) || 9 < Math.abs(H(a,
                            "Y") - i)) m = !0
                }
    ...
    (function (a, b, l, k) {
        var c, j = a.extend, f = a.mobiscroll, i = f.classes, s = f.util, q = s.prefix, d = s.jsPrefix, g = s.has3d,
            O = s.getCoord, m = s.testTouch, M = s.vibrate, w = 1, A = function () {
            }, y = b.requestAnimationFrame || function (a) {
                a()
            }, D = b.cancelAnimationFrame || A, C = "webkitAnimationEnd animationend", p = "transparent";
        i.ListView = function (e, f) {
            ...
            function H(b) {
                ...
                if (m(b, this) && !ka && !hb && !c && !Mb && a.mobiscroll.running && (Ba = ka = !0, Nb = O(b, "X"), Ob = O(b, "Y"), Ga = na = 0, da = a(this), u(), Wb = fa.onItemTap || Aa.tap || da.hasClass("mbsc-lv-parent") || da.hasClass("mbsc-lv-back"), Ma.offset(), pb = da.offset().top, Wb && (sa = setTimeout(function () {
                    ...
                    }, 120)), aa.sortable && !da.hasClass("mbsc-lv-back") && ((aa.sortable.group || (Xb = da.nextUntil(".mbsc-lv-gr-title").filter(".mbsc-lv-item"), Yb = da.prevUntil(".mbsc-lv-gr-title").filter(".mbsc-lv-item")),
                        qb = (!aa.sortable.group ? Yb.length ? Yb.eq(-1) : da : ma.children("li").eq(0))[0].offsetTop - La, ib = (!aa.sortable.group ? Xb.length ? Xb.eq(-1) : da : ma.children("li").eq(-1))[0].offsetTop - La, aa.sortable.handle) ? a(b.target).hasClass("mbsc-lv-handle") && (clearTimeout(sa), "Moz" === d ? (b.preventDefault(), R()) : Pb = setTimeout(function () {
                        R()
            ...
            function o(a) {
                ...
                if (ka) if (rb = O(a, "X"), Fb = O(a, "Y"), na = rb - Nb, Ga = Fb - Ob, clearTimeout(cb), !Xa && !jb && !vb && !da.hasClass("mbsc-lv-back") && (10 < Math.abs(Ga) ? (vb = !0, a.type = "mousemove" == a.type ? "mouseup" : "touchend", G(a), clearTimeout(sa)) : 7 < Math.abs(na) ? J() : "touchmove" === a.type && (cb = setTimeout(function () {
                        a.type = "touchend";
                        G(a)
                    }, 300))), jb) a.preventDefault(), oa =
                    100 * (na / bb), S(); else if (Xa) {
                    a.preventDefault();
                    var h, d = Na.scrollTop(), Q = Math.max(qb, Math.min(Ga + wb, ib)), e = Wa ? pb - hc + d - wb : pb;
                    ...
                    if (kb && (aa.sortable.multiLevel && va.hasClass("mbsc-lv-parent") ? La + Ea / 4 + Q > kb ? c = !0 : La + Ea - Ea / 4 + Q > kb && (Ia = va.addClass("mbsc-lv-item-hl"), b = !1) : La + Ea / 2 + Q > kb && (va.hasClass("mbsc-lv-back") ? aa.sortable.multiLevel && (pa = va.addClass("mbsc-lv-item-hl"), b = !1) : c = !0), c)) db.insertAfter(va),
                        Oa = va, va = ha(va, "next"), lb = kb, kb = va.length && va[0].offsetTop, Ca++;
                    if (!c && lb && (aa.sortable.multiLevel && Oa.hasClass("mbsc-lv-parent") ? La + Ea - Ea / 4 + Q < lb ? c = !0 : La + Ea / 4 + Q < lb && (Ia = Oa.addClass("mbsc-lv-item-hl"), b = !1) : La + Ea / 2 + Q < lb && (Oa.hasClass("mbsc-lv-back") ? aa.sortable.multiLevel && (pa = Oa.addClass("mbsc-lv-item-hl"), b = !1) : c = !0), c)) db.insertBefore(Oa), va = Oa, Oa = ha(Oa, "prev"), kb = lb, lb = Oa.length && Oa[0].offsetTop + Oa.outerHeight(), Ca--;
            ...
            function G(c) {
                ...
                if (ka) {
                    ...
                    if (jb || vb || Xa) Jb = !0;
                    jb ? K() : Xa ? (b = ma, Ia ? (T(da.detach()), c = eb[Ia.attr("data-ref")], Ca = N(c.child).length, Ia.removeClass("mbsc-lv-item-hl"), fa.navigateOnDrop ? la(Ia, function () {
                        aa.add(null, da, null, null, Ia, !0);
                        t(da);
                        h(da, ra, b, !0)
                    }) : (aa.add(null, da, null, null, Ia,
                        !0), h(da, ra, b, !0))) : pa ? (T(da.detach()), c = eb[pa.attr("data-back")], Ca = N(c.parent).index(c.item) + 1, pa.removeClass("mbsc-lv-item-hl"), fa.navigateOnDrop ? la(pa, function () {
                        aa.add(null, da, Ca, null, ma, !0);
                        t(da);
                        h(da, ra, b, !0)
                    }) : (aa.add(null, da, Ca, null, c.parent, !0), h(da, ra, b, !0))) : (c = db[0].offsetTop - La, r(da, c, 6 * Math.abs(c - Math.max(qb, Math.min(Ga + wb, ib))), function () {
                        T(da);
                        da.insertBefore(db);
                        h(da, ra, b, Ca !== ra)
                    })), Xa = !1) : !vb && 5 > Math.abs(na) && 5 > Math.abs(Ga) && (Aa.tap && (d = Aa.tap.call(Ra, da, ra, c, aa)), Wb && ("touchend" ===
                    c.type && s.preventClick(), da.addClass("mbsc-lv-item-active"), za("onItemActivate", [da, c])), d = za("onItemTap", [da, ra, c]), !1 !== d && la(da));
                    clearTimeout(sa);
                    setTimeout(function () {
            ...
            function J() {
                if (jb = V(Aa.swipe, [da, ra, 0 < na ? "right" : "left", aa])) U(), clearTimeout(sa), Aa.actions ? (Q = ja(Aa), Pa.html(Aa.icons).show().children().css("width", Q + "%"), Pa.find(".mbsc-lv-multi-ic-right").css("margin-left", 100 - Q + "%"), Fa.hide(), a(".mbsc-lv-ic-m",
                    Da).removeClass("mbsc-lv-ic-disabled"), a(Aa.leftMenu).each(x), a(Aa.rightMenu).each(x)) : (Fa.show(), Pa.hide(), Sa = Aa.start + (0 < na ? 0 : 1), sb = Eb[Sa - 1], tb = Eb[Sa]), da.addClass("mbsc-lv-item-swiping").removeClass("mbsc-lv-item-active"), Qb.css("line-height", Ea + "px"), Da.css({
                    top: La,
                    height: Ea,
                    backgroundColor: (0 < na ? Aa.right : Aa.left).color || p
                }).addClass("mbsc-lv-stage-c-v").appendTo(ma), fa.iconSlide && da.append(Fa), za("onSlideStart", [da, ra])
            }

            function S() {
                var a = !1;
                if (!Rb) {
                    if (Aa.actions) Da.attr("class", "mbsc-lv-stage-c-v mbsc-lv-stage-c mbsc-lv-" +
                        (0 > oa ? "right" : "left")); else if (sb && oa <= sb.percent ? (Sa--, tb = sb, sb = Eb[Sa], a = !0) : tb && oa >= tb.percent && (Sa++, sb = tb, tb = Eb[Sa], a = !0), a) if (Ja = 0 < oa ? sb : tb) X(Ja, fa.iconSlide), za("onStageChange", [da, ra, Ja]);
                    xb || (Rb = !0, ic = y(v))
                }
            }
            ...
            function K(b) {
                ...
                Rb = !1;
                xb || v();
                if (Aa.actions) 10 < Math.abs(oa) && Q && (W(da, 0 > oa ? -Q : Q, 200), c = e = !0, ia = da, Qa = ra, a(l).on("touchstart.mbsc-lv-conf mousedown.mbsc-lv-conf", function (a) {
                    a.preventDefault();
                    P(da, !0, b)
                })); else if (fa.quickSwipe && !xb && (d = new Date - fc, h = 300 > d && -50 > na, d = 300 >
                        d && 50 < na, h ? (Kb = !0, Ja = Aa.left, X(Ja, fa.iconSlide)) : d && (Kb = !0, Ja = Aa.right, X(Ja, fa.iconSlide))), Ja && Ja.action) Ta = V(Ja.disabled, [da, ra, aa]), Ta || (e = !0, (c = xb || V(Ja.confirm, [da, ra, aa])) ? (W(da, 100 * (0 > oa ? -1 : 1) * Fa.outerWidth(!0) / bb, 200, !0), n(Ja, da, ra, !1, b)) : L(Ja, da, ra, b));
                e || P(da, !0, b);
                jb = !1
            }
            ...
            function R() {
                ...
                da.css({top: La}).addClass("mbsc-lv-item-dragging").removeClass("mbsc-lv-item-active").appendTo(Ua);
            ...
            function L(c, b, d, h) {
                var Q, e = {
                    icon: "undo2", text: fa.undoText, color: "#b1b1b1",
                    action: function () {
                        aa.undo()
                    }
                };
            ...
            function P(b, d, h) {
                ...
                Fa.off(".mbsc-lv-conf");
                !1 !==
                d ? W(b, 0, "0" !== b.attr("data-pos") ? 200 : 0, !1, function () {
                    E(b, h);
                    T(b)
                }) : E(b, h);
                c = !1
            ...
            function r(a, c, b, h) {
                ...
                $a = a[0].style;
                g ? ($a[d + "Transform"] = "translate3d(0," + c + "px,0)", $a[d + "Transition"] =
                    q + "transform " + (b || 0) + "ms ease-out") : $a.top = La + c + "px";
            ...
            function U() {
                clearTimeout(Pb);
                !Ba && aa.sortable && fa.fillAnimation && (Ba = !0, xa.remove())
            }
            ...
            function Y(a) {
                ...
                Tb ? aa.animate(db, "collapse", function () {
                    db.remove()
                }) : db.remove();
                E();
                Tb = Sb = null
            ...
            function ca(a, c, b, d) {
                var h = c.parent(), Q = c.prev(), d = d || A;
                Q[0] === Fa[0] && (Q = Fa.prev());
                ma[0] !== c[0] ? (za("onNavStart", [zb, a, c]), $b.prepend(c.addClass("mbsc-lv-v mbsc-lv-sl-new")), t(ya),
                    $($b, "mbsc-lv-sl-" + a, function () {
            ...
            function la(a, c) {
                hb || (a.hasClass("mbsc-lv-parent") ? (zb++, ca("r", eb[a.attr("data-ref")].child, null, c)) : a.hasClass("mbsc-lv-back") && (zb--, ca("l", eb[a.attr("data-back")].parent, eb[a.attr("data-back")].item,
                    c)))
            }
            ...
            function ta(c, b, d) {
                var h, Q;
                c && c.length && (h = 100 / (c.length + 2), a.each(c, function (a, e) {
                    e.key ===
                    k && (e.key = bc++);
                    e.percent === k && (e.percent = b * h * (a + 1), d && (Q = j({}, e), Q.key = bc++, Q.percent = -h * (a + 1), c.push(Q), Ub[Q.key] = Q));
                    Ub[e.key] = e
                }))
            }

            var ka, Q, sa, oa, Ba, ia, Qa, ya, Ca, ua, ma, nb, ob, Db, Ja, Sa, Va, Za, Ta, na, Ga, Ia, pa, Xa, Ua, cb,
                rb,
                Fb, za, xa, fb, wa, Ab, Bb, Vb, z, Wa, mb, Hb, Ha, yb, Ya, gb, Gb, Ka, ab, qa, Fa, Da, bb, da, Ea, ra,
                pb,
                ib, qb, Pa, va, kb, tb, Xb, Jb, Lb, gc, Yb, db, Oa, lb, sb, Kb, ic, Rb, fa, vb, xb, $b, bc, Eb, ec, fc,
                Nb,
                Ob, $a, jb, cc, jc, Wb, Qb, Pb, Aa, ub, Sb, Tb, Na, Zb, wb, hc, aa = this, Ra = e, Ma = a(Ra), hb = 0,
                zb = 0, La = 0, Ub = {}, ac = {}, eb = {};
            i.Base.call(this, e,
                f, !0);
            ...
            aa.add = function (c, b, d, h, Q, e) {
                ...
                I(p, function (c) {
                    ...
                    if (n = eb[m]) if (n.child.length) oa = n.child; else {
                        x.addClass("mbsc-lv-parent").prepend(ab);
                        oa = x.children("ul,ol").prepend(Ka).addClass("mbsc-lv");
                        n.child = oa;
                        a(".mbsc-lv-back", x).attr("data-back", m)
                    }
                    eb[s] = {item: p, child: p.children("ul,ol"), parent: oa, ref: m};
                    i = N(oa);
                    g = i.length;
                    if (d === k || d === null) d = g;
                    e && (j = "mbsc-lv-item-new-" + (e ? y : ""));
                    Z(p.addClass(j));
                    if (d !== false) if (g) d < g ? p.insertBefore(i.eq(d)) : p.insertAfter(i.eq(g - 1)); else {
                        f = a(".mbsc-lv-back", oa);
                        f.length ? p.insertAfter(f) : oa.append(p)
                    }
                    if (oa.hasClass("mbsc-lv-v")) aa.animate(p.height(p.outerHeight()), e && Sb === s ? "none" : "expand", function (a) {
                        aa.animate(a.height(""), e ? "add-" + y : "pop-in", function (a) {
                            h.call(Ra,
                                a.removeClass(j));
                            c()
                        })
                    ...
                    ya.trigger("mbsc-enhance", [{theme: fa.theme, lang: fa.lang}]);
                    za("onItemAdd", [p])
                })
            };
            ...
            aa.remove = function (a, c, b, d) {
                ...
                a.length && (Q = a.parent(), h = N(Q).index(a), d || (a.attr("data-ref") === Sb && (Tb = !0), aa.addUndoAction(function (c) {
                    ...
                    if (Q.hasClass("mbsc-lv-v")) aa.animate(a.addClass("mbsc-lv-removed"), d ? "pop-out" : "remove-" + c, function (a) {
                        aa.animate(a.height(a.outerHeight()),
                            "collapse", function (a) {
            ...
            aa.navigate = function (a, c) {
                ...
                d = 0;
                for (var h = eb[a.attr("data-ref")]; h.ref;) d++, h = eb[h.ref];
                b && (ca(d >= zb ? "r" : "l", b.parent, a, c), zb = d)
            };
            aa.init = function (d) {
                var h =
                    Ma.find("ul,ol").length ? "left" : "right", Q = 0, e = "", f = "", i = "";
                aa._init(d);
                d = fa.sort || fa.sortable;
                "group" === d && (d = {group: !1, multiLevel: !0});
                !0 === d && (d = {group: !0, multiLevel: !0, handle: fa.sortHandle});
                ...
                Da = a('<div class="mbsc-lv-stage-c">' +
                    e + "</div>");
                ...
                Na.on("orientationchange.mbsc-lv resize.mbsc-lv", function () {
                    clearTimeout(Va);
                ...
                Ra.addEventListener && Ra.addEventListener("click", function (a) {
                    if (Jb) {
                        a.stopPropagation();
                        a.preventDefault();
                        Jb = false
                ...
                ya.on("touchstart mousedown", ".mbsc-lv-ic-m", function (a) {
                    if (!Za) {
                        a.stopPropagation();
                        a.preventDefault()
                    }
                ...
                fa.fixedHeader &&
                (wa = a('<div class="mbsc-lv-fixed-header"></div>'), Ab = a(".mbsc-lv-gr-title", Ma), Wa ? (Na.before(wa), wa.addClass("mbsc-lv-fixed-header-ctx mbsc-lv-" + fa.theme + (fa.baseTheme ? " mbsc-lv-" + fa.baseTheme : ""))) : ya.prepend(wa), Na.on("scroll.mbsc-lv touchmove.mbsc-lv", function () {
                    if (Xa || !ka) {
                        var b = a(this).scrollTop(), c = Ma.offset().top;
                ...
                fa.hover && (Ya = fa.hover.time || 200, gb = fa.hover.timeout || 200, Hb = fa.hover.direction || fa.hover || "right", ya.on("mouseenter.mbsc-lv", ".mbsc-lv-item", function () {
                    if (!Ha || Ha[0] != this) {
                        B();
                        Ha = a(this);
            ...
            aa.undo = function () {
                ...
                function b() {
                    if (h = kc.shift()) Mb = !0, d = h.length - 1, a()
                }
    ...
    (function (a) {
        var b = a.mobiscroll.themes.listview, l = {
    ...
    (function (a) {
        a.mobiscroll.themes.listview.jqm = {
            ...
            onInit: function () {
                a(this).closest(".mbsc-lv-cont").addClass(a(this).data("inset") ? "mbsc-lv-jqm-inset" :
    ...
    (function (a, b) {
        var l = function () {
        }, k = a.mobiscroll, c = k.util, j = c.getCoord, f = c.testTouch;
        k.classes.Slider = function (i, s, q) {
            ...
            function g(a) {
                if (B) {
                    ...
                    L = P - ga;
                    n = W - ja;
                    if (5 < Math.abs(L) || ba) ba = !0, 50 < Math.abs(ta - new Date) && (ta = new Date, p(P, ea.round, Y));
            ...
            function M() {
                var b = I._readValue(a(this)), c = +a(this).attr("data-index");
                b !== $[c] && ($[c] = b, F(b, c))
            }
            ...
            function p(a, b, c) {
                a = b ? Math.min(100 * Math.round(Math.max(100 * (a - v) / la, 0) / ha / N) * N / (T - V), 100) : Math.max(0, Math.min(100 * (a - v) /
                    la, 100));
            ...
            function F(a, c, d, h, f, g) {
                var i = G.eq(c), B = i.parent(), a = Math.min(T, Math.max(a, V));
                g === b && (g = d);
                E ? 0 === c ? (a = Math.min(a, $[1]), K.css({
                    width: e($[1]) - e(a) + "%",
                    left: e(a) + "%"
                })) : (a = Math.max(a, $[0]), K.css({width: e(a) - e($[0]) + "%"})) : Z || !U ? B.css({
                    left: (h || e(a)) + "%",
                    right: "auto"
                }) : K.css("width", (h || e(a)) + "%");
                X && R.eq(c).html(a);
                a > V ? B.removeClass("mbsc-slider-start") : ($[c] > V || f) && B.addClass("mbsc-slider-start");
                !Z && ($[c] != a || f) && I._display(a);
                d && $[c] != a && (x = !0, $[c] = a, I._fillValue(a, c, g));
                i.attr("aria-valuenow", a)
            }

            var u, H, o, G, J, S, K, R, h, B, x, L, n, v, P, W, r, U, X, E, Y, T, V, ba, Z, N, ea, ha, ga, ja, t, ca,
                la, $,
                I = this, ta = new Date;
    ...
    (function (a, b, l, k) {
        var c, j, f = a.mobiscroll, i = f.util, s = i.jsPrefix, q = i.has3d, d = i.constrain, g = i.isString,
            O = i.isOldAndroid, i = /(iphone|ipod|ipad).* os 8_/i.test(navigator.userAgent), m = function () {
            }, M = function (a) {
                a.preventDefault()
            };
        f.classes.Frame = function (i, A, y) {
            function D(b) {
                ...
                if ("mousedown" === b.type) a(l).on("mouseup", C); else if ("pointerdown" === b.type) a(l).on("pointerup", C)
            }
            ...
            function o(b, d) {
                b && b();
                a(l.activeElement).is("input,textarea") && a(l.activeElement).blur();
                !1 !== t.show() && (c = d, setTimeout(function () {
                    j = !1
                }, 300))
            }
            ...
            var K, R, h, B, x, L, n, v, P, W, r, U, X, E, Y, T, V, ba, Z,
                N, ea, ha, ga, ja, t = this, ca = a(i), la = [], $ = {};
            f.classes.Base.call(this, i, A, !0);
            t.position = function (b) {
                var c, h, e, f, g, i, m, x, p, j, y = 0, s = 0;
                p = {};
                var E = Math.min(v[0].innerWidth || v.innerWidth(), L.width()), r = v[0].innerHeight || v.innerHeight();
                g = a(l.activeElement);
                if (g.is("input,textarea") && !/(button|submit|checkbox|radio)/.test(g.attr("type"))) g.on("blur", H); else if (!(ga === E && ja === r && b || Z)) if ((t._isFullScreen || /top|bottom/.test(N.display)) && n.width(E), !1 !== X("onPosition", [B, E, r]) && Y) {
                    h = v.scrollLeft();
                    b = v.scrollTop();
                    f = N.anchor === k ? ca : a(N.anchor);
                    t._isLiquid && "liquid" !== N.layout && (400 > E ? B.addClass("dw-liq") : B.removeClass("dw-liq"));
                    !t._isFullScreen && /modal|bubble/.test(N.display) && (P.width(""), a(".mbsc-w-p", B).each(function () {
                    ...
                    L.css({height: p});
                    if (j && (e + V > b + r || i > b + r)) Z = !0, setTimeout(function () {
                        Z = false
                    }, 300), v.scrollTop(Math.min(i, e + V - r, p - r));
                    ga = E;
                    ja = r;
            ...
            t.attachShow = function (a, b) {
                la.push({readOnly: a.prop("readonly"), el: a});
                if ("inline" !== N.display) {
                    if (ha && a.is("input")) a.prop("readonly", !0).on("mousedown.dw", function (a) {
                        a.preventDefault()
                    });
                    ...
                    N.showOnTap && (a.on("keydown.dw", function (c) {
                        if (32 == c.keyCode || 13 == c.keyCode) c.preventDefault(), c.stopPropagation(), o(b, a)
                    }), t.tap(a, function () {
                        o(b, a)
                    }))
                }
            ...
            t.show = function (c, d) {
                ...
                if (!N.disabled && !t._isVisible) {
                    ...
                    U = O ? !1 : N.animate;
                    !1 !== U && ("top" == N.display && (U = "slidedown"), "bottom" == N.display && (U = "slideup"));
                    e = '<div lang="' + N.lang + '" class="mbsc-' + N.theme + (N.baseTheme ? " mbsc-" + N.baseTheme : "") + " dw-" + N.display + " " + (N.cssClass || "") + (t._isLiquid ? " dw-liq" : "") + (O ? " mbsc-old" : "") + (E ? "" : " dw-nobtn") + '"><div class="dw-persp">' + (Y ? '<div class="dwo"></div>' : "") + "<div" +
                        (Y ? ' role="dialog" tabindex="-1"' : "") + ' class="dw' + (N.rtl ? " dw-rtl" : " dw-ltr") + '">' + ("bubble" === N.display ? '<div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div>' : "") + '<div class="dwwr"><div aria-live="assertive" class="dw-aria dw-hidden"></div>' + (N.headerText ? '<div class="dwv">' + (g(N.headerText) ? N.headerText : "") + "</div>" : "") + '<div class="dwcc">';
                    e += t._generateContent();
                    e += "</div>";
                    E && (e += '<div class="dwbc">', a.each(W, function (a, b) {
                        b = g(b) ? t.buttons[b] : b;
                        if (b.handler ===
                    ...
                    if (Y) {
                        a(b).on("keydown", p);
                        if (N.scrollLock) B.on("touchmove mousewheel wheel", function (a) {
                            ea && a.preventDefault()
                        });
                    ...
                    t.position();
                    v.on(ba, F);
                    B.on("selectstart mousedown", M).on("click", ".dwb-e", M).on("keydown", ".dwb-e", function (b) {
                        if (b.keyCode == 32) {
                            b.preventDefault();
                            b.stopPropagation();
                            a(this).click()
                        ...
                        function (b) {
                            if (b.keyCode == 32) b.preventDefault(); else if (b.keyCode == 9 && Y && N.focusTrap) {
                                var c = B.find('[tabindex="0"]').filter(function () {
                                    return this.offsetWidth > 0 || this.offsetHeight > 0
                                }), d = c.index(a(":focus", B)), h = c.length - 1, e = 0;
                                if (b.shiftKey) {
                                    h = 0;
                                    e = -1
                                }
                    ...
                    a("input,select,textarea", B).on("selectstart mousedown", function (a) {
                        a.stopPropagation()
                    }).on("keydown", function (a) {
                        a.keyCode == 32 && a.stopPropagation()
                    });
                    a.each(W, function (b, c) {
                        t.tap(a(".dwb" + b, B), function (a) {
                            c =
                                g(c) ? t.buttons[c] : c;
                            (g(c.handler) ? t.handlers[c.handler] : c.handler).call(this, a, t)
                        }, true)
                    });
                    N.closeOnOverlay && t.tap(x, function () {
                        t.cancel()
                    });
            ...
            t.hide = function (c, d, h, g) {
                ...
                B && ("Moz" !== s && a(".dwtd", R).each(function () {
                    a(this).prop("disabled",
                        !1).removeClass("dwtd")
                }), q && Y && U && !c && !B.hasClass("dw-trans") ? B.addClass("dw-out dw-trans").on("webkitAnimationEnd animationend", function () {
                    e(c)
            ...
            t.init = function (c) {
                ...
                t._init(c);
                t._isLiquid = "liquid" === (N.layout ||
                    (/top|bottom/.test(N.display) ? "liquid" : ""));
                t._processSettings();
                ca.off(".dw");
                W = N.buttons || [];
                Y = "inline" !== N.display;
                ...
                t.buttons.set = {text: N.setText, handler: "set"};
                t.buttons.cancel = {text: t.live ? N.closeText : N.cancelText, handler: "cancel"};
                t.buttons.clear = {text: N.clearText, handler: "clear"};
                t._isInput = ca.is("input");
                E = 0 < W.length;
                t._isVisible && t.hide(!0, !1, !0);
                X("onInit", []);
                Y ? (t._readValue(), t._hasContent || t.attachShow(ca)) : t.show();
                ca.on("change.dw", function () {
                    t._preventChange || t.setVal(ca.val(), true, false);
                    t._preventChange = false
                })
            };
            t.buttons = {};
            t.handlers = {set: t.select, cancel: t.cancel, clear: t.clear};
            t._value = null;
            t._isValid = !0;
            t._isVisible = !1;
            N = t.settings;
    ...
    (function (a) {
        var b = a.mobiscroll.themes.frame, l = {
            minWidth: 76,
            height: 76,
            ...
            onMarkupInserted: function (b, c) {
                ...
                if ("clickpick" != s.mode) a(".dwwl", b).on("touchstart mousedown wheel mousewheel", function (c) {
                    if (!("mousedown" === c.type && f || (a.isArray(s.readonly) ? s.readonly[a(".dwwl", b).index(this)] : s.readonly))) f = "touchstart" === c.type, j = !0, i = a(this).hasClass("wpa"), a(".dwwl", b).removeClass("wpa"), a(".dw-sel", this).removeClass("dw-sel"), a(this).addClass("wpa")
    ...
    (function (a) {
        ...
        a.mobiscroll.themes.frame.jqm = {
            ...
            onThemeLoad: function (l, k) {
                var c = k.jqmBody || "c", j = k.jqmEventText || "b", f = k.jqmEventBubble || "a";
            ...
            onMarkupInserted: function (l, k) {
                var c = k.settings;
                b && (l.addClass("mbsc-jqm14"), a(".mbsc-np-btn, .dwwb, .dw-cal-sc-m-cell .dw-i", l).addClass("ui-btn"), a(".dwbc .dwb, .dw-dr",
                    l).addClass("ui-btn ui-mini ui-corner-all"), a(".dw-cal-prev .dw-cal-btn-txt", l).addClass("ui-btn ui-icon-arrow-l ui-btn-icon-notext ui-shadow ui-corner-all"), a(".dw-cal-next .dw-cal-btn-txt", l).addClass("ui-btn ui-icon-arrow-r ui-btn-icon-notext ui-shadow ui-corner-all"));
                ...
                a(".dwb-s .dwb", l).addClass("ui-btn-" +
                    c.jqmSet).attr("data-theme", c.jqmSet);
                ...
                a(".dw-cal-prev .dw-cal-btn-txt", l).attr("data-role", "button").attr("data-icon", "arrow-l").attr("data-iconpos",
                    "notext");
    ...
    (function (a) {
        a.mobiscroll.themes.frame.bootstrap = {
            ...
            onEventBubbleShow: function (b, l) {
                ...
                setTimeout(function () {
                    l.hasClass("dw-cal-events-b") ?
                        l.removeClass("top").addClass("bottom") : l.removeClass("bottom").addClass("top")
                }, 10)
            }
        }
    })(jQuery);
    (function (a, b) {
        var l, k = function () {
        }, c = a.mobiscroll, j = c.util, f = j.getCoord, i = j.testTouch;
        c.classes.Form = function (b, q) {
            function d(b) {
                var c = {}, d = b[0], f = b.parent(), g = b.attr("data-password-toggle"),
                    i = b.attr("data-icon-show") || "eye", m = b.attr("data-icon-hide") || "eye-blocked";
                g && (c.right = "password" == d.type ? i : m);
                j.addIcon(b, c);
                g && p.tap(f.find(".mbsc-right-ic"), function () {
                    if (d.type == "text") {
                        d.type = "password";
            ...
            p.refresh = function () {
                a("input,select,textarea,progress,button", C).each(function () {
                    ...
                    var m, k, s, o, q = this, w = a(q), S = w.parent();
                    m = w.attr("data-role");
                    ...
                    if ("false" != w.attr("data-enhance") && a.mobiscroll.running) {
                        if (!w.hasClass("mbsc-control")) switch (/(switch|range|segmented|stepper)/.test(m) && (K = m), "button" != K && "submit" != K && "segmented" != K && (S.find("label").addClass("mbsc-label"), S.contents().filter(function () {
                            ...
                            case "progress":
                                M(q) ||
                                new c.classes.Progress(q, {theme: A.theme});
                                break;
                            case "radio":
                            ...
                            case "stepper":
                                M(q) ||
                                new c.classes.Stepper(q, {form: p});
                                break;
                            case "hidden":
                                break;
                            default:
                                d(w), S.addClass("mbsc-input")
                        }
                        if (!w.hasClass("mbsc-control-ev")) {
                            /select/.test(K) && (w.on("change.mbsc-form", b), b());
                            if ("textarea" == K) w.on("keydown.mbsc-form input.mbsc-form", function () {
                                clearTimeout(y);
                                y = setTimeout(function () {
                                    O(q)
                                }, 100)
                            }).on("scroll.mbsc-form", g);
                            w.addClass("mbsc-control-ev").on("touchstart.mbsc-form mousedown.mbsc-form", function (b) {
                                if (i(b, this)) {
                                    s = f(b, "X");
                                    o = f(b, "Y");
            ...
            p.init = function (b) {
                ...
                w = "mbsc-form mbsc-" + A.theme + (A.baseTheme ? " mbsc-" + A.baseTheme : "") +
        ...
        c.classes.Stepper = function (j, k) {
            ...
            function l(b) {
                if (i(b, this) && !j.disabled && a.mobiscroll.running &&
                    (p = a(this).addClass("mbsc-active").focus(), Y && Y.trigger("onControlActivate", [p, b]), y(b), "mousedown" === b.type)) a(document).on("mousemove", M).on("mouseup", m)
            }
            ...
            function A(a, c, d) {
                ...
                d === b && (d = c);
                P = a !== b ? Math.min(h,
                    Math.max(Math.round(a / x) * x, B)) : Math.min(h, Math.max(P + (p.hasClass("mbsc-stepper-minus") ? -x : x), B));
                o = !0;
            ...
            var p, e, F, u, H, o, G, J, S, K, R, h, B, x, L, n, v, P, W = this, r = a(j),
                U = r.hasClass("mbsc-stepper-ready"), X = U ? r.closest(".mbsc-stepper-cont") : r.parent(), E = P,
                Y = k.form;
            c.classes.Base.call(this, j, k, !0);
            W.getVal = function () {
                var a = parseFloat(r.val()), a = isNaN(a) ? P : a;
            ...
            W.destroy = function () {
                ...
                u.off("keydown", d).off("keyup", g).off("mousedown touchstart",
                    l).off("touchmove", M).off("touchend touchcancel", m);
                W._destroy()
            };
            W.init(k)
        };
        c.classes.Stepper.prototype = {_class: "stepper", _defaults: {min: 0, max: 100, step: 1}};
        c.presetShort("stepper", "Stepper");
        c.classes.Switch = function (b, f) {
            var d, g, i, m = this, f = f || {};
            a.extend(f, {
                changeEvent: "click",
                min: 0,
                max: 1,
    ...
    (function (a, b, l, k) {
        var b = a.mobiscroll, c = b.classes, j = b.util, f = j.jsPrefix, i = j.has3d, s = j.hasFlex, q = j.getCoord,
            d = j.constrain, g = j.testTouch;
        b.presetShort("scroller", "Scroller", !1);
        c.Scroller = function (b, m, M) {
            function w(b) {
                if (g(b, this) && !t && !V && !P && !H(this) && a.mobiscroll.running && (b.preventDefault(), b.stopPropagation(), W = "clickpick" != E.mode, t = a(".dw-ul", this), G(t), ha = (ba = ka[ca] !== k) ? Math.round(-j.getPosition(t, !0) / r) : Q[ca], Z = q(b, "Y", !0), N = new Date, ea = Z, K(t, ca, ha, 0.001), W && t.closest(".dwwl").addClass("dwa"),
                    "mousedown" === b.type)) a(l).on("mousemove", A).on("mouseup", y)
            }

            function A(a) {
                if (t && W && (a.preventDefault(), a.stopPropagation(), ea = q(a, "Y", !0), 3 < Math.abs(ea - Z) || ba)) K(t, ca, d(ha + (Z - ea) / r, ga - 1, ja + 1)), ba = !0
            }

            function y(b) {
                if (t) {
                    var c = new Date - N, h = d(Math.round(ha + (Z - ea) / r), ga - 1, ja + 1), e = h, f,
                        g = t.offset().top;
                    b.stopPropagation();
                    "mouseup" === b.type && a(l).off("mousemove", A).off("mouseup", y);
                    i && 300 > c ? (f = (ea - Z) / c, c = f * f / E.speedUnit, 0 > ea - Z && (c = -c)) : c = ea - Z;
                    if (ba) e = d(Math.round(ha - c / r), ga, ja), c = f ? Math.max(0.1, Math.abs((e -
                        h) / f) * E.timeUnit) : 0.1; else {
                        var h = Math.floor((ea - g) / r), m = a(a(".dw-li", t)[h]);
                        f = m.hasClass("dw-v");
                        g = W;
                        c = 0.1;
                        !1 !== T("onValueTap", [m]) && f ? e = h : g = !0;
            ...
            function F(b) {
                if (!H(this) && a.mobiscroll.running) {
                    b.preventDefault();
                    var b = b.originalEvent || b, c = b.deltaY || b.wheelDelta || b.detail, h = a(".dw-ul", this);
                    G(h);
            ...
            function o(b) {
                var c = '<div class="dw-bf">', b = sa[b], d = 1, h = b.labels || [], f = b.values || [],
                    e = b.keys || f;
                a.each(f, function (b, f) {
                    0 === d % 20 && (c += '</div><div class="dw-bf">');
                    c += '<div role="option" aria-selected="false" class="dw-li dw-v" data-val="' + e[b] + '"' + (h[b] ? ' aria-label="' +
                        h[b] + '"' : "") + ' style="height:' + r + "px;line-height:" + r + 'px;"><div class="dw-i"' + (1 < la ? ' style="line-height:' + Math.round(r / la) + "px;font-size:" + Math.round(0.8 * (r / la)) + 'px;"' : "") + ">" + f + "</div></div>";
                    d++
                });
                return c += "</div>"
            }
            ...
            function R(b, c, h, e,
                       f) {
                var g = a('.dw-li[data-val="' + b + '"]', c), i = a(".dw-li", c), b = i.index(g), m = i.length;
                if (e) G(c); else if (!g.hasClass("dw-v")) {
                    for (var Q = g, n = 0, j = 0; 0 <= b - n && !Q.hasClass("dw-v");) n++, Q = i.eq(b - n);
                    for (; b + j < m && !g.hasClass("dw-v");) j++, g = i.eq(b + j);
                    (j < n && j && 2 !== h || !n || 0 > b - n || 1 == h) && g.hasClass("dw-v") ? b += j : (g = Q, b -= n)
                }
                h = g.hasClass("dw-sel");
                f && (e || (a(".dw-sel", c).removeAttr("aria-selected"), g.attr("aria-selected", "true")), a(".dw-sel", c).removeClass("dw-sel"), g.addClass("dw-sel"));
                return {
                    selected: h, v: e ? d(b, ga, ja) :
                        b, val: g.hasClass("dw-v") || e ? g.attr("data-val") : null
                }
            }

            function h(b, c, d, h, e) {
                !1 !== T("validate", [v, c, b, h]) && (a(".dw-ul", v).each(function (d) {
                    var f = a(this), g = f.closest(".dwwl").hasClass("dwwms"), i = d == c || c === k,
                        g = R(I._tempWheelArray[d], f, h, g, !0);
                    if (!g.selected || i) I._tempWheelArray[d] = g.val, K(f, d, g.v, i ? b : 0.1, i ? e : !1)
            ...
            function n(a, b, c, d, e) {
                ...
                a && (T("onValueFill", [I._hasValue ? I._tempValue : "", b]), I._isInput && ta.val(I._hasValue ?
                    I._tempValue : ""), b && (I._preventChange = !0, ta.change()))
            }

            var v, P, W, r, U, X, E, Y, T, V, ba, Z, N, ea, ha, ga, ja, t, ca, la, $, I = this, ta = a(b), ka = {},
                Q = {},
                sa = [];
            ...
            I.changeWheel = function (b, c, d) {
                if (v) {
                    var e = 0, f = b.length;
                    a.each(E.wheels, function (g, i) {
                        a.each(i, function (g, i) {
                            if (-1 < a.inArray(e, b) && (sa[e] = i, a(".dw-ul", v).eq(e).html(o(e)), f--, !f)) return I.position(), h(c, k, d), !1;
                            e++
                        });
                        if (!f) return !1
                    })
                ...
                a.each(E.wheels, function (h, e) {
                    ...
                    a.each(e, function (a, h) {
                        ...
                        c += "<" + (s ? "div" : "td") + ' class="dwfl" style="' + (E.fixedWidth ? "width:" + (E.fixedWidth[d] || E.fixedWidth) + "px;" : (E.minWidth ? "min-width:" + (E.minWidth[d] || E.minWidth) + "px;" : "min-width:" + E.width + "px;") + (E.maxWidth ? "max-width:" + (E.maxWidth[d] || E.maxWidth) + "px;" : "")) + '"><div class="dwwl dwwl' + d + (h.multiple ? " dwwms" : "") + '">' + ("scroller" != E.mode ? '<div class="dwb-e dwwb dwwbp ' + (E.btnPlusClass || "") + '" style="height:' + r + "px;line-height:" + r + 'px;"><span>+</span></div><div class="dwb-e dwwb dwwbm ' + (E.btnMinusClass ||
                            "") + '" style="height:' + r + "px;line-height:" + r + 'px;"><span>&ndash;</span></div>' : "") + '<div class="dwl">' + b + '</div><div tabindex="0" aria-live="off" aria-label="' + b + '" role="listbox" class="dwww"><div class="dww" style="height:' + E.rows * r + 'px;"><div class="dw-ul" style="margin-top:' + (h.multiple ? "scroller" == E.mode ? 0 : r : E.rows / 2 * r - r / 2) + 'px;">';
                        c += o(d) + '</div></div><div class="dwwo"></div></div><div class="dwwol"' + (E.selectedLineHeight ? ' style="height:' + r + "px;margin-top:-" + (r / 2 + (E.selectedLineBorder || 0)) +
                            'px;"' : "") + "></div></div>" + (s ? "</div>" : "</td>");
                        d++
                    });
    ...
    (function (a, b) {
        var l = a.mobiscroll, k = l.util.isNumeric, c = function () {
        }, j = l.classes;
        j.Numpad = function (c, i, s) {
            function l(b) {
                ...
                if (o._isVisible && a.mobiscroll.running) {
                    ...
                    a(".mbsc-np-cph", M).each(function () {
                        a(this).html(S[a(this).attr("data-var")] ||
                            a(this).attr("data-ph"))
                    });
            ...
            function d(b, c, d, g) {
                c && l();
                g || (u = p.slice(0), K = a.extend({}, S), G = J.slice(0), o._value = o._tempValue);
            ...
            function g(a) {
                ...
                J = [];
                S = {};
                for (a = 0; a < c.length; a++) /:/.test(c[a]) ? (b = c[a].split(":"), S[b[0]] = b[1], J.push(b[0])) : (d.push(c[a]), J.push("digit"));
                return d
            }

            function O(b, c) {
                if (!(!y && !c && !D.allowLeadingZero || b.hasClass("dwb-d") || b.hasClass("mbsc-np-btn-empty")) && y < F && a.mobiscroll.running) J.push("digit"), p.push(c), l(!0)
            }
            ...
            function m() {
                ...
                if (y || "digit" !== c) {
                    if ("digit" !== c && S[c]) {
                        ...
                        b = J.slice(0);
                        J = [];
                        for (a = 0; a < b.length; a++) b[a] !== c && J.push(b[a])
                    } else p.pop();
                    l(!0)
                }
            }

            var M, w, A, y, D, C, p, e, F, u,
                H = a(c), o = this, G = [], J = [], S = {}, K = {}, R = {
                    48: 0,
                    49: 1,
                    50: 2,
                    51: 3,
            ...
            j.Frame.call(this, c, i, !0);
            o.setVal = o._setVal = function (h, e, i, m) {
                o._hasValue = null !== h && h !== b;
                p = g(a.isArray(h) ? h.slice(0) : D.parseValue.call(c, h, o));
                d(e, !0, i === b ? e : i, m)
            };
            o.getVal = o._getVal = function (a) {
                return o._hasValue || a ? o[a ? "_tempValue" : "_value"] : null
            };
            o.setArrayVal = o.setVal;
            o.getArrayVal = function (a) {
                return a ? p.slice(0) : o._hasValue ? u.slice(0) : null
            };
            o.setValue =
                o.setVal;
            o.getValue = o.getArrayVal;
            o._readValue = function () {
                var a = H.val() || "";
                "" !== a && (o._hasValue = !0);
                C ? (S = {}, J = [], p = []) : (S = o._hasValue ? K : {}, J = o._hasValue ? G : [], p = o._hasValue && u ? u.slice(0) : g(D.parseValue.call(c, a, o)), d(!1, !0))
            };
            ...
            o._generateContent = function () {
                ...
                g = "" + ('<div class="mbsc-np-hdr"><div role="button" tabindex="0" aria-label="' +
                    D.deleteText + '" class="mbsc-np-del dwb-e mbsc-ic mbsc-ic-' + D.deleteIcon + '"></div><div class="mbsc-np-dsp">');
                b = D.template.replace(/d/g, '<span class="mbsc-np-ph">' + A + "</span>").replace(/&#100;/g, "d");
                b = b.replace(/{([a-zA-Z0-9]*)\:?([a-zA-Z0-9\-\_]*)}/g, '<span class="mbsc-np-cph" data-var="$1" data-ph="$2">$2</span>');
                g = g + b + '</div></div><div class="mbsc-np-tbl-c mbsc-w-p"><div class="mbsc-np-tbl">';
                for (b = 0; 4 > b; b++) {
                    g += '<div class="mbsc-np-row">';
                    for (c = 0; 3 > c; c++) d = e, 10 == e || 12 == e ? d = "" : 11 == e && (d = 0), g =
                        "" === d ? 10 == e && D.leftButton ? g + ('<div role="button" tabindex="0" class="mbsc-np-btn mbsc-np-btn-custom dwb-e" ' + (D.leftButton.variable ? 'data-var="' + D.leftButton.variable + '"' : "") + ' data-val="' + D.leftButton.value + '" >' + D.leftButton.text + "</div>") : 12 == e && D.rightButton ? g + ('<div role="button" tabindex="0" class="mbsc-np-btn mbsc-np-btn-custom dwb-e" ' + (D.rightButton.variable ? 'data-var="' + D.rightButton.variable + '"' : "") + ' data-val="' + D.rightButton.value + '" >' + D.rightButton.text + "</div>") : g + '<div class="mbsc-np-btn mbsc-np-btn-empty"></div>' :
                            g + ('<div tabindex="0" role="button" class="mbsc-np-btn dwb-e" data-val="' + d + '">' + d + "</div>"), e++;
                    g += "</div>"
                }
                return g + "</div></div>"
            };
            ...
            o._attachEvents = function (c) {
                c.on("keydown", function (c) {
                    R[c.keyCode] !== b ? O(a('.mbsc-np-btn[data-val="' + R[c.keyCode] + '"]'), R[c.keyCode]) : 8 == c.keyCode && (c.preventDefault(), m())
                });
                o.tap(a(".mbsc-np-btn", c), function () {
                    var b = a(this);
                    if (b.hasClass("mbsc-np-btn-custom")) {
                        var c = b.attr("data-val"), d = b.attr("data-var");
                        if (!b.hasClass("dwb-d")) {
                            d && (b = d.split(":"), J.push(b[0]), S[b[0]] = b[1]);
                            if (c.length + y <= e) for (b = 0; b < c.length; ++b) J.push("digit"), p.push(k(c[b]) ? +c[b] : c[b]);
                            l(!0)
                        }
                    } else O(b, +b.attr("data-val"))
                });
                o.tap(a(".mbsc-np-del", c), m)
            };
            o._processSettings = function () {
                D = o.settings;
                D.headerText = (D.headerText || "").replace("{value}", "");
                D.cssClass = (D.cssClass || "") + " mbsc-np";
                D.template = D.template.replace(/\\d/, "&#100;");
                A = D.placeholder;
                F = (D.template.match(/d/g) || []).length;
                w = "dwb-d " + (D.disabledClass || "");
                (C = D.mask) &&
                H.is("input") && H.attr("type", "password")
            };
            o._indexOf = function (a, b) {
                var c;
        ...
        j.Numpad.prototype = {
            ...
            _defaults: a.extend({}, j.Frame.prototype._defaults, {
                ...
                validate: c,
                parseValue: c,
                formatValue: function (b, c, j) {
                    var k,
                        d = 1;
                    k = j.settings;
                    var j = k.placeholder, g = k.template, l = b.length, m = g.length, M = "";
                    for (k = 0; k < m; k++) "d" == g[m - k - 1] ? (M = d <= l ? b[l - d] + M : j + M, d++) : M = g[m - k - 1] + M;
        ...
        l.themes.numpad = l.themes.frame;
        l.presetShort("numpad", "Numpad", !1)
    })(jQuery);
    (function (a) {
        var b = a.mobiscroll, l = {min: 0, max: 99.99, scale: 2, prefix: "", suffix: "", returnAffix: !1};
        b.presets.numpad.decimal = function (k) {
            function c(a) {
                var b;
                b = a.slice(0);
            ...
            function j(a) {
                return c(a).toFixed(i.scale).replace(".", i.decimalSeparator).replace(/\B(?=(\d{3})+(?!\d))/g, i.thousandsSeparator)
            }

            var f = a.extend({}, k.settings), i = a.extend(k.settings, l, f);
            k.getVal = function (a) {
                a = k._getVal(a);
                return b.util.isNumeric(a) ? +a : a
            };
            return {
                template: i.prefix.replace(/d/g,
                    "\\d") + Array((Math.floor(i.max) + "").length + 1).join("d") + (i.scale ? "." + Array(i.scale + 1).join("d") : "") + i.suffix.replace(/d/g, "\\d"),
                ...
                validate: function (b) {
                    var f = j(b), d = c(b), g = [];
                    !b.length && !i.allowLeadingZero && g.push(0);
                    k.isVisible() &&
                    a(".mbsc-np-dsp", k._markup).html(i.prefix + f + i.suffix);
                    return {
                        disabled: g,
                        invalid: d > i.max || d < i.min || (i.invalid ? -1 != k._indexOf(i.invalid, d) : !1)
                    }
                }
            }
        }
    ...
    (function (a) {
        function b(a) {
            for (var b = 0, c = 1, k = 0; a.length;) 3 < b ? c = 3600 : 1 < b && (c = 60), k += a.pop() * c * (b % 2 ? 10 : 1), b++;
            return k
        }

        var l = a.mobiscroll, k = ["h", "m", "s"],
            c = {min: 0, max: 362439, defaultValue: 0, hourTextShort: "h", minuteTextShort: "m", secTextShort: "s"};
        l.presets.numpad.timespan = function (j) {
            function f(b) {
                var c, f = "", i = 3600;
                a(k).each(function (a, j) {
                    c = Math.floor(b / i);
                    b -= c * i;
                    i /= 60;
                    if (0 < c || "s" == j && !f) f = f + (f ? " " : "") + c + q[j]
                });
                return f
            }

            var i = a.extend({}, j.settings), s = a.extend(j.settings, c, i), q = {
                h: s.hourTextShort.replace(/d/g,
                    "\\d"), m: s.minuteTextShort.replace(/d/g, "\\d"), s: s.secTextShort.replace(/d/g, "\\d")
            }, i = 'd<span class="mbsc-np-sup mbsc-np-time">' + q.s + "</span>";
            9 < s.max && (i = "d" + i);
            99 < s.max && (i = '<span class="mbsc-np-ts-m">' + (639 < s.max ? "d" : "") + 'd</span><span class="mbsc-np-sup mbsc-np-time">' + q.m + "</span>" + i);
            6039 < s.max && (i = '<span class="mbsc-np-ts-h">' + (38439 < s.max ? "d" : "") + 'd</span><span class="mbsc-np-sup mbsc-np-time">' + q.h + "</span>" + i);
            j.setVal = function (a, b, c, i) {
                l.util.isNumeric(a) && (a = f(a));
                return j._setVal(a,
                    b, c, i)
            };
            j.getVal = function (a) {
                return j._hasValue || a ? b(j.getArrayVal(a)) : null
            };
            return {
                template: i, parseValue: function (b) {
                    var c, i = b || f(s.defaultValue), m = [];
                    i && a(k).each(function (a, b) {
                        (c = RegExp("(\\d+)" + q[b], "gi").exec(i)) ? (c = +c[1], 9 < c ? (m.push(Math.floor(c / 10)), m.push(c % 10)) : (m.length && m.push(0), (c || m.length) && m.push(c))) : m.length && (m.push(0), m.push(0))
                    });
                    return m
                }, formatValue: function (a) {
                    return f(b(a))
                    ...
                    a.length || f.push(0);
                    return {
                        disabled: f, invalid: c > s.max ||
                        c < s.min || (s.invalid ? -1 != j._indexOf(s.invalid, +c) : !1)
                    }
                }
            }
        }
    ...
    (function (a) {
        ...
        a.mobiscroll.presets.numpad.time = function (l) {
            ...
            var c = a.extend({}, l.settings), j = a.extend(l.settings, b, c), f = j.timeFormat.split(":"),
                i = j.timeFormat.match(/a/i), s = i ? "a" == i[0] ? j.amText : j.amText.toUpperCase() : "",
                q = i ? "a" == i[0] ? j.pmText : j.pmText.toUpperCase() : "", d = 0, g = j.min ? "" + j.min.getHours() :
            ...
            return {
                ...
                template: (3 == f.length ? "dd:dd:dd" :
                    2 == f.length ? "dd:dd" : "dd") + (i ? '<span class="mbsc-np-sup">{ampm:--}</span>' : ""),
                leftButton: i ? {text: s, variable: "ampm:" + s, value: "00"} : {text: ":00", value: "00"},
                rightButton: i ? {text: q, variable: "ampm:" + q, value: "00"} : {text: ":30", value: "30"},
                parseValue: function (a) {
                    var b, c = a || j.defaultValue, d = [];
                    if (c) {
                        c += "";
                ...
                validate: function (a, b) {
                    ...
                    if (!i && (2 > e - a.length || 1 != a[0] && (2 < a[0] || 3 < a[1]) && 2 >= e - a.length)) J.push("30"), J.push("00");
                    if ((i ? 1 < a[0] || 2 < a[1] : 1 != a[0] && (2 < a[0] || 3 < a[1])) && a[0]) a.unshift(0), d = e - 1;
                    if (a.length == e) for (e = 0; 9 >= e; ++e) J.push(e); else if (1 == a.length && i && 1 == a[0] || a.length && 0 === a.length % 2 || !i && 2 == a[0] &&
                        3 < a[1] && 1 == a.length % 2) for (e = 6; 9 >= e; ++e) J.push(e);
                    ...
                    if (j.min || j.max) {
                        ...
                        q = s && q;
                        if (0 === a.length) {
                            for (e = i ? 2 : 19 < g ? g[0] : 3; e <= (1 == g[0] ? 9 : g[0] -
                                1); ++e) J.push(e);
                        ...
                        if (3 == a.length && (u && a[2] == M[0] || s && a[2] == m[0])) for (e = u && a[2] ==
                        M[0] ? +M[1] + 1 : 0; e < (s && a[2] == m[0] ? +m[1] : 10); ++e) J.push(e);
                    ...
                    return {
                        disabled: J,
                        length: d,
                        invalid: (i ? !RegExp("^(0?[1-9]|1[012])(:[0-5]\\d)?(:[0-5][0-9]) (?:" + j.amText + "|" + j.pmText + ")$", "i").test(c) : !/^([0-1]?[0-9]|2[0-4]):([0-5][0-9])(:[0-5][0-9])?$/.test(c)) || (j.invalid ? -1 != l._indexOf(j.invalid, p) : !1) || !((j.min ? j.min <=
                            p : 1) && (j.max ? p <= j.max : 1))
                    }
                }
            }
    ...
    (function (a) {
        var b = a.mobiscroll, l = {dateOrder: "mdy", dateFormat: "mm/dd/yy", delimiter: "/"};
        b.presets.numpad.date = function (k) {
            ...
            var j, f, i, s, q = [];
            s = a.extend({}, k.settings);
            var d = a.extend(k.settings, b.datetime.defaults, l, s), g = d.dateOrder,
                O = d.min ? "" + (d.getMonth(d.min) + 1) : 0, m = d.max ? "" + (d.getMonth(d.max) + 1) : 0,
                M = d.min ? "" + d.getDay(d.min) : 0, w = d.max ? "" + d.getDay(d.max) : 0,
                A = d.min ? "" + d.getYear(d.min) : 0, y = d.max ? "" + d.getYear(d.max) :
            ...
            g = "";
            q.push({val: j, n: "yyyy"}, {val: f, n: "mm"}, {val: i, n: "dd"});
            q.sort(function (a, b) {
                return a.val - b.val
            });
            ...
            return {
                ...
                fill: "ltr", allowLeadingZero: !0, template: g, parseValue: function (a) {
                    ...
                    var b = c(a), g, e, l, s, q = [], o = void 0 !==
                        a[j + 3] ? "" + a[j] + a[j + 1] + a[j + 2] + a[j + 3] : "",
                        G = void 0 !== a[f + 1] ? "" + a[f] + a[f + 1] : "",
                        J = void 0 !== a[i + 1] ? "" + a[i] + a[i + 1] : "",
                        S = "" + d.getMaxDayOfMonth(o || 2012, G - 1 || 0), K = A === o && +O === +G,
                        R = y === o && +m === +G;
                    ...
                    if (a.length == i) {
                        for (g = R ? (10 <
                        +w ? +w[0] : 0) + 1 : +S[0] + 1; 9 >= g; ++g) q.push(g);
    ...
    (function (a) {
        ...
        b.datetime = {
            defaults: {
                ...
                if (!k) return null;
                var c = a.extend({}, b.datetime.defaults, c), j = function (a) {
                    for (var b =
                        0; s + 1 < l.length && l.charAt(s + 1) == a;) b++, s++;
                    return b
                }, f = function (a, b, c) {
                    b = "" + b;
                ...
                for (s = 0; s < l.length; s++) if (g) "'" == l.charAt(s) && !j("'") ? g = !1 : d += l.charAt(s); else switch (l.charAt(s)) {
                    case "d":
                        d += f("d", c.getDay(k), 2);
                        break;
                    case "D":
                ...
                var c = a.extend({}, b.datetime.defaults, c), j = c.defaultValue || new Date;
                if (!l || !k) return j;
                if (k.getTime) return k;
                var k = "object" == typeof k ? k.toString() : k + "", f = c.shortYearCutoff, i = c.getYear(j),
                    s = c.getMonth(j) + 1, q = c.getDay(j), d = -1, g = j.getHours(), O = j.getMinutes(), m = 0, M = -1,
                    w = !1, A = function (a) {
                        (a = p + 1 < l.length && l.charAt(p + 1) == a) && p++;
                        return a
                    }, y = function (a) {
                        A(a);
                        ...
                        a = A(a) ? c : b;
                        for (b = 0; b < a.length; b++) if (k.substr(C, a[b].length).toLowerCase() == a[b].toLowerCase()) return C += a[b].length, b + 1;
                        return 0
                    }, C = 0, p;
                for (p = 0; p < l.length; p++) if (w) "'" == l.charAt(p) && !A("'") ? w = !1 : C++; else switch (l.charAt(p)) {
                    case "d":
                        q = y("d");
                        break;
                    case "D":
                ...
                g = c.getDate(i, s -
                    1, q, -1 == M ? g : M && 12 > g ? g + 12 : !M && 12 == g ? 0 : g, O, m);
    ...
    (function (a, b) {
        var l = a.mobiscroll, k = l.classes, c = l.util, j = c.constrain, f = c.jsPrefix, i = c.prefix, s = c.has3d,
            q = c.getCoord, d = c.getPosition, g = c.testTouch, O = c.isNumeric, m = c.isString,
        ...
        k.ScrollView = function (c, l, D) {
            function C(b) {
                ...
                (ia.prevDef || "mousedown" == b.type) && b.preventDefault();
                if ((!ia.lock || !Y) && g(b, this) && !E && a.mobiscroll.running) if (G && G.removeClass("mbsc-btn-a"), W = !1, Y || (G = a(b.target).closest(".mbsc-btn-e",
                        this), G.length && !G.hasClass("mbsc-btn-d") && (W = !0, J = setTimeout(function () {
                        G.addClass("mbsc-btn-a")
                    }, 100))), E = !0, T = !1, Q.scrolled = Y, t = q(b, "X"), ca = q(b, "Y"), n = t, h = R = K = 0, ja = new Date, ga = +d($, ka) || 0, o(ga, 1), "mousedown" === b.type) a(document).on("mousemove", p).on("mouseup", F); else if ("pointerdown" === b.type) a(document).on("pointermove", p).on("pointerup", F)
            }
            ...
            function p(a) {
                if (E) {
                    ...
                    R = v - ca;
                    h = ka ? R : K;
                    if (W && (5 < Math.abs(R) || 5 < Math.abs(K))) clearTimeout(J), G.removeClass("mbsc-btn-a"),
                        W = !1;
                    if (Q.scrolled || !T && 5 < Math.abs(h)) Q.scrolled || ta("onGestureStart", [P]), Q.scrolled = !0, ia.liveSwipe && !ba && (ba = !0, V = M(e));
            ...
            function F(b) {
                if (E) {
                    ...
                    w(V);
                    ba = !1;
                    !T && Q.scrolled && (ia.momentum && s && 300 > c && (c = h / c, h = Math.max(Math.abs(h), c * c / ia.speedUnit) * (0 > h ? -1 : 1)), ta("onGestureEnd",
                        [P]), H(h));
            ...
            function u(b) {
                ...
                ia.stopProp && b.stopPropagation();
                h && a.mobiscroll.running && (b.preventDefault(), h = 0 > h ? 20 : -20, ga = sa, ba || (ba = !0, V = M(e)), clearTimeout(Z),
            ...
            function o(a, b, c) {
                ...
                s ? (la[f + "Transition"] = b ? i + "transform " + Math.round(b) + "ms " + x : "", la[f + "Transform"] = "translate3d(" + (ka ? "0," + a + "px," : a + "px,0,") + "0)") : la[B] = a + "px";
                !g && !Y || !b || 1 >= b ? e() : b && (Y = !0, clearInterval(N),
            ...
            var G, J, S, K, R, h, B, x, L, n, v, P, W, r, U, X, E, Y, T, V, ba, Z, N, ea, ha, ga, ja, t, ca, la, $, I,
                ta,
                ka, Q = this, sa = 0, oa = 0, Ba = 1, ia = l, Qa = a(c);
    ...
    (function (a, b) {
        var l = {invalid: [], showInput: !0, inputClass: ""};
        a.mobiscroll.presets.scroller.list = function (k) {
            function c(b, c, d, g) {
                for (var e, f = 0; f < c;) {
                    ...
                    for (e = 0; e < m.length;) m[e].invalid && k.push(m[e].key), e++;
                    j = k;
            ...
            function f(a, c, d) {
                ...
                for (; g < a.length;) {
                    ...
                    if (c !== b && m[c].children) g++, m = m[c].children; else if ((f = i(m)) && f.children) g++, m = f.children; else break
                }
                return j
            }
            ...
            function d(a, c) {
                var d = [], g = o, e = 0, f = !1, j, m;
                if (a[e] !== b && e <= c) {
                    f = 0;
                    j = a[e];
                    for (m = b; f < g.length && m === b;) g[f].key == a[e] && !g[f].invalid && (m = f), f++
                } else m = i(g, !0), j = g[m].key;
                ...
                for (d[e] = j; f;) {
                    ...
                    if (a[e] !== b && e <= c) {
                        ...
                        j = a[e];
                        for (m = b; f < g.length && m === b;) g[f].key == a[e] && !g[f].invalid && (m = f), f++
                    } else m = i(g, !0), m = !1 === m ? b : m, j = g[m].key;
            ...
            var O = a.extend({}, k.settings), m = a.extend(k.settings, l,
                O), O = m.layout || (/top|bottom/.test(m.display) ? "liquid" : ""), M = "liquid" == O, w = m.readonly,
                A = a(this), y, D, C = this.id + "_dummy", p = 0, e = 0, F = {}, u, H = [], o = m.wheelArray || g(A),
                G = function (a) {
                    var b = [], c;
                    ...
                    var b = [], c;
                    c = !0;
                    for (var d = 0; c;) c = i(a), b[d++] = c.key, (c = c.children) && (a = c);
                    return b
                }(o), S = f(J, p);
            a("#" + C).remove();
            m.showInput && (y = a('<input type="text" id="' + C + '" value="" class="' + m.inputClass + '" placeholder="' + (m.placeholder || "") + '" readonly />').insertBefore(A),
                m.anchor = y, k.attachShow(y));
            m.wheelArray || A.hide().closest(".ui-field-contain").trigger("create");
            return {
                width: 50, wheels: S, layout: O, headerText: !1, formatValue: function (a) {
                    ...
                    var i = [], l = k.getArrayVal(true), s = (g || 0) + 1, n, v;
    ...
    (function (a, b) {
        var l = a.mobiscroll, k = l.datetime, c = new Date, j = {
            ...
            function g(a) {
                if (null === a) return a;
                var b = f(a, "y"), c = f(a, "m"), d = Math.min(f(a, "d"), x.getMaxDayOfMonth(b, c)), g = f(a, "h", 0);
            ...
            function O(a, b) {
                ...
                a > t && (a = t);
                d = c = a;
                if (2 !== b) for (e = m(c); !e && c < t;) c = new Date(c.getTime() + 864E5), e = m(c), h++;
                if (1 !== b) for (f = m(d); !f && d > ja;) d = new Date(d.getTime() - 864E5), f = m(d), i++;
                return 1 ===
                b && e ? c : 2 === b && f ? d : i <= h && f ? d : c
            }
            ...
            function w(a, b, c, d, g, e, f) {
                var h,
                    i, m;
                if (a) for (h = 0; h < a.length; h++) if (i = a[h], m = i + "", !i.start) if (i.getTime) x.getYear(i) == b && x.getMonth(i) == c && (e[x.getDay(i) - 1] = f); else if (m.match(/w/i)) {
                    m = +m.replace("w", "");
                    for (o = m - d; o < g; o += 7) 0 <= o && (e[o] = f)
                } else m = m.split("/"), m[1] ? m[0] - 1 == c && (e[m[1] - 1] = f) : e[m[0] - 1] = f
            }

            function A(c, g, e, f, i, m, j, k, l) {
                var E, r, o, q, t, p, s, Z, w, v, W, I, P, A, u, N, $, M, ta = {}, F = {h: ea, i: ha, s: ga, a: 1},
                    C = x.getDate(i, m, j), L = ["a", "h", "i", "s"];
                c && (a.each(c, function (a, b) {
                    if (b.start && (b.apply = !1, E = b.d, r = E + "", o = r.split("/"), E && (E.getTime && i ==
                            x.getYear(E) && m == x.getMonth(E) && j == x.getDay(E) || !r.match(/w/i) && (o[1] && j == o[1] && m == o[0] - 1 || !o[1] && j == o[0]) || r.match(/w/i) && C.getDay() == +r.replace("w", "")))) b.apply = !0, ta[C] = !0
                    ...
                    if (f.start && (f.apply || !f.d && !ta[C])) {
                        ...
                        if (!l) for (v = g + 1; 4 > v; v++) 0 < q[v] && (P = F[e]), t[v] < B[L[v]] && (A = F[e]);
                        ...
                        if (p || s || u) l ? a(".dw-li", k).slice(W, I).addClass("dw-v") : a(".dw-li",
                            k).slice(W, I).removeClass("dw-v")
                    }
                }))
            }
            ...
            function C(a) {
                var b, c, d, g = [];
                if (a) {
                    for (b = 0; b < a.length; b++) if (c = a[b], c.start && c.start.getTime) for (d = new Date(c.start); d <= c.end;) g.push(new Date(d.getFullYear(), d.getMonth(), d.getDate())), d.setDate(d.getDate() + 1); else g.push(c);
                    return g
                }
                return a
            }
            ...
            if (p.is("input")) {
                ...
                var u = p.attr("min"), p = p.attr("max");
                u && (e.minDate = k.parseDate(F, u));
                p && (e.maxDate = k.parseDate(F, p))
            }
            var H, o, G, J, S, K, R, h, B, u = a.extend({}, c.settings),
                x = a.extend(c.settings, l.datetime.defaults, j, e, u), L = 0, n = [], e = [], v = [], P = {}, W = {},
                r = {
                    y: function (a) {
                        return x.getYear(a)
                    },
                ...
                }, U = x.invalid, X = x.valid, u = x.preset, E = x.dateOrder, Y = x.timeWheels, T = E.match(/D/),
                V = Y.match(/a/i), ba = Y.match(/h/),
                Z = "datetime" == u ? x.dateFormat + x.separator + x.timeFormat : "time" == u ? x.timeFormat :
                    x.dateFormat, N = new Date, p = x.steps || {}, ea = p.hour || x.stepHour || 1,
                ha = p.minute || x.stepMinute || 1, ga = p.second || x.stepSecond || 1, p = p.zeroBased,
                ja = x.minDate || new Date(x.startYear, 0, 1), t = x.maxDate || new Date(x.endYear, 11, 31, 23, 59, 59),
                ca = p ? 0 : ja.getHours() % ea, la = p ? 0 : ja.getMinutes() % ha, $ = p ? 0 : ja.getSeconds() % ga,
                I = Math.floor(((ba ? 11 : 23) - ca) / ea) * ea + ca, ta = Math.floor((59 - la) / ha) * ha + la,
            ...
            if (u.match(/date/i)) {
                ...
                for (o = 0; 3 > o; o++) if (o == P.y) {
                    ...
                    S = x.getYear(ja);
                    K = x.getYear(t);
                    for (H = S; H <= K; H++) G.push(H), J.push((E.match(/yy/i) ? H : (H + "").substr(2, 2)) + (x.yearSuffix || ""));
                    q(p, G, J, x.yearText)
                } else if (o == P.m) {
                    L++;
                    J = [];
                    G = [];
                    for (H = 0; 12 > H; H++) S = E.replace(/[dy]/gi, "").replace(/mm/, (9 > H ? "0" + (H + 1) : H + 1) + (x.monthSuffix || "")).replace(/m/, H + 1 + (x.monthSuffix || "")), G.push(H), J.push(S.match(/MM/) ? S.replace(/MM/, '<span class="dw-mon">' +
                        x.monthNames[H] + "</span>") : S.replace(/M/, '<span class="dw-mon">' + x.monthNamesShort[H] + "</span>"));
                    q(p, G, J, x.monthText)
                } else if (o == P.d) {
                    L++;
                    J = [];
                    G = [];
                    for (H = 1; 32 > H; H++) G.push(H), J.push((E.match(/dd/i) && 10 > H ? "0" + H : H) + (x.daySuffix || ""));
                    q(p, G, J, x.dayText)
                }
                e.push(p)
            }
            if (u.match(/time/i)) {
                ...
                for (o = L; o < L + 4; o++) if (o == P.h) {
                    ...
                    J = [];
                    G = [];
                    for (H = ca; H < (ba ? 12 : 24); H += ea) G.push(H), J.push(ba && 0 === H ? 12 : Y.match(/hh/i) && 10 > H ? "0" + H : H);
                    q(p, G, J, x.hourText)
                } else if (o == P.i) {
                    L++;
                    J = [];
                    G = [];
                    for (H = la; 60 > H; H += ha) G.push(H), J.push(Y.match(/ii/) && 10 > H ? "0" + H : H);
                    q(p, G, J, x.minuteText)
                } else if (o == P.s) {
                    L++;
                    J = [];
                    G = [];
                    for (H = $; 60 > H; H += ga) G.push(H), J.push(Y.match(/ss/) && 10 > H ? "0" + H : H);
                    q(p, G, J, x.secText)
            ...
            c.buttons.now = {text: x.nowText, handler: "now"};
            U = C(U);
            X = C(X);
            h = {y: ja.getFullYear(), m: 0, d: 1, h: ca, i: la, s: $, a: 0};
            B = {y: t.getFullYear(), m: 11, d: 31, h: I, i: ta, s: ka, a: 1};
            return {
                ...
                parseValue: function (a) {
                    ...
                    var e = O(g(c.getArrayVal(!0)), j), k = D(e), l = f(k, "y"), v = f(k, "m"), q = !0, o = !0;
                    a.each("y,m,d,a,h,i,s".split(","), function (c, g) {
                        if (P[g] !== b) {
                            var e = h[g], i = B[g], m = 31, j = f(k, g), n = a(".dw-ul", d).eq(P[g]);
                            if (g == "d") {
                                i = m = x.getMaxDayOfMonth(l, v);
                                T && a(".dw-li", n).each(function () {
                                    var b = a(this), c = b.data("val"), d = x.getDate(l, v, c).getDay(),
                                        c = E.replace(/[my]/gi, "").replace(/dd/, (c < 10 ? "0" +
                                            c : c) + (x.daySuffix || "")).replace(/d/, c + (x.daySuffix || ""));
                    ...
                    R && a.each(["a", "h", "i", "s"], function (g, e) {
                        var h = f(k, e), m = f(k, "d"), E = a(".dw-ul", d).eq(P[e]);
    ...
    (function (a, b, l, k) {
        var c = a.mobiscroll, j = c.presets.scroller, f = c.util, i = f.has3d, s = f.jsPrefix, q = f.testTouch, d = {
            controls: ["calendar"],
            firstDay: 0,
            weekDays: "short",
            maxMonthWidth: 170,
        ...
        j.calbase = function (b) {
            function O(b, c, d) {
                var g, e, f, h, i = {}, m = qa + Ia;
                b && a.each(b, function (a, b) {
                    g = b.d || b.start || b;
                    e = g + "";
                    if (b.start && b.end) for (h = new Date(b.start); h <= b.end;) f = new Date(h.getFullYear(), h.getMonth(), h.getDate()), i[f] = i[f] || [], i[f].push(b), h.setDate(h.getDate() + 1); else if (g.getTime) f = new Date(g.getFullYear(), g.getMonth(), g.getDate()), i[f] = i[f] || [], i[f].push(b); else if (e.match(/w/i)) {
                        var j = +e.replace("w", ""),
                            k = 0, n = z.getDate(c, d - qa - pa, 1).getDay();
                        1 < z.firstDay - n + 1 && (k = 7);
                        for (v = 0; v < 5 * Ga; v++) f = z.getDate(c, d - qa - pa, 7 * v - k - n + 1 + j), i[f] = i[f] || [], i[f].push(b)
                    } else if (e = e.split("/"), e[1]) 11 <= d + m && (f = z.getDate(c + 1, e[0] - 1, e[1]), i[f] = i[f] || [], i[f].push(b)), 1 >= d - m && (f = z.getDate(c - 1, e[0] - 1, e[1]), i[f] = i[f] || [], i[f].push(b)), f = z.getDate(c, e[0] - 1, e[1]), i[f] = i[f] || [], i[f].push(b); else for (v = 0; v < Ga; v++) f = z.getDate(c, d - qa - pa + v, e[0]), z.getDay(f) == e[0] && (i[f] = i[f] || [], i[f].push(b))
                });
                return i
            }
            ...
            function M(a, b, c, d, e, g, f) {
                ...
                for (n = 1; n <= b; n++) h = 12 >= n || n > c ? h + '<div class="dw-cal-sc-m-cell dw-cal-sc-cell dw-cal-sc-empty"><div class="dw-i">&nbsp;</div></div>' : h + ('<div tabindex="0" role="button"' + (g ? ' aria-label="' + g[n - 13] + '"' : "") + ' class="dwb-e dwb-nhl dw-cal-sc-m-cell dw-cal-sc-cell dw-cal-' +
                    a + '-s" data-val=' + (d + n - 13) + '><div class="dw-i dw-cal-sc-tbl"><div class="dw-cal-sc-cell">' + (f ? f[n - 13] : d + n - 13 + e) + "</div></div></div>"), n < b && (0 === n % 12 ? h += '</div></div></div><div class="dw-cal-sc-p" style="' + (Ka ? "top" : Ya ? "right" : "left") + ":" + 100 * Math.round(n / 12) + '%"><div class="dw-cal-sc-tbl"><div class="dw-cal-sc-row">' : 0 === n % 3 && (h += '</div><div class="dw-cal-sc-row">'));
                return h + "</div></div></div></div></div>"
            }

            function w(c, d) {
                var e, f, h, i, m, j, n, l, E, r, v, q, o, t, p = 1, Z = 0;
                e = z.getDate(c, d, 1);
                var w = z.getYear(e),
                    s = z.getMonth(e), Q = null === z.defaultValue && !b._hasValue ? null : b.getDate(!0),
                    W = z.getDate(w, s, 1).getDay(), I = '<div class="dw-cal-table">', P = '<div class="dw-week-nr-c">';
                1 < z.firstDay - W + 1 && (Z = 7);
                for (t = 0; 42 > t; t++) o = t + z.firstDay - Z, e = z.getDate(w, s, o - W + 1), f = e.getFullYear(), h = e.getMonth(), i = e.getDate(), m = z.getMonth(e), j = z.getDay(e), q = z.getMaxDayOfMonth(f, h), n = f + "-" + h + "-" + i, h = a.extend({
                    valid: e < new Date(Qa.getFullYear(), Qa.getMonth(), Qa.getDate()) || e > ya ? !1 : Ja[e] === k || Db[e] !== k,
                    selected: Q && Q.getFullYear() === f && Q.getMonth() ===
                    h && Q.getDate() === i
                }, b.getDayProps(e, Q)), l = h.valid, E = h.selected, f = h.cssClass, r = e.getTime() === (new Date).setHours(0, 0, 0, 0), v = m !== s, Ab[n] = h, 0 === t % 7 && (I += (t ? "</div>" : "") + '<div class="dw-cal-row' + (z.highlight && Q && 0 <= Q - e && 6048E5 > Q - e ? " dw-cal-week-hl" : "") + '">'), mb && 1 == e.getDay() && ("month" == mb && v && 1 < p ? p = 1 == i ? 1 : 2 : "year" == mb && (p = z.getWeekNumber(e)), P += '<div class="dw-week-nr"><div class="dw-week-nr-i">' + p + "</div></div>", p++), I += '<div role="button" tabindex="-1" aria-label="' + (r ? z.todayText + ", " : "") + z.dayNames[e.getDay()] +
                    ...
                    j + "</div>" + (h.markup || "") + '<div class="dw-cal-day-frame"></div></div></div>';
                return I + ("</div></div>" + P + "</div>")
            }

            function A(b, c, d) {
                var e = z.getDate(b, c, 1), g = z.getYear(e), e = z.getMonth(e), f = g + Ea;
                if (ab) {
                ...
                for (n = 0; n < na; ++n) e = z.getDate(b, c - pa + n, 1), g = z.getYear(e), e = z.getMonth(e), f = g + Ea, a(la[n]).attr("aria-label",
                    z.monthNames[e] + (Fa ? "" : " " + g)).html((!Fa && ta < $ ? f + " " : "") + ja[e] + (!Fa && ta > $ ? " " + f : "")), 1 < I.length && a(I[n]).html(f);
            ...
            function C(c, d) {
                if (ba && ("calendar" === Va || d)) {
                    ...
                    d || (b.trigger("onDayHighlight", [c]), z.highlight && (a(".dw-sel .dw-i", X).removeClass(ra), a(".dw-sel", X).removeClass("dw-sel").removeAttr("aria-selected"),
                        a(".dw-cal-week-hl", X).removeClass("dw-cal-week-hl"), (null !== z.defaultValue || b._hasValue) && a('.dw-cal-day[data-full="' + c.getFullYear() + "-" + c.getMonth() + "-" + c.getDate() + '"]', X).addClass("dw-sel").attr("aria-selected", "true").find(".dw-i").addClass(ra).closest(".dw-cal-row").addClass("dw-cal-week-hl")));
                    b.needsSlide = !0
                }
            }
            ...
            function u(c, d, f, h, i, j, k) {
                c && fb.push({y: c, m: d, dir: f, slideNr: h, load: i, active: j, callback: k});
                if (!Za) {
                    var l = fb.shift(), c = l.y, d = l.m, f = "next" === l.dir, h = l.slideNr, i = l.load, j = l.active,
                        k = l.callback || Bb, l = z.getDate(c, d, 1), c = z.getYear(l),
                        d = z.getMonth(l);
                    Za = !0;
                    b.changing = !0;
                            ...
                            t.scroll(T, ga ? 200 : 0, function () {
                                setTimeout(function () {
                                    ...
                                    if (xa.length) {
                                        ...
                                        if (f) {
                                            m = xa.splice(0, h);
                                            for (n = 0; n < h; n++) xa.push(m[n]), o(xa[xa.length - 1], +xa[xa.length - 2].data("curr") + 100 * gb)
                                        } else {
                                            m =
                                                xa.splice(Ga - h, h);
                                            for (n = h - 1; 0 <= n; n--) xa.unshift(m[n]), o(xa[0], +xa[1].data("curr") - 100 * gb)
                                        }
                                        for (n = 0; n < h; n++) xa[f ? Ga - h + n : n].html(w(c, d - pa - qa + n + (f ? Ga - h : 0))), i && xa[f ? n : Ga - h + n].html(w(c, d - pa - qa + n + (f ? 0 : Ga - h)));
            ...
            function H() {
                var c = a(this), d = b.live, e = b.getDate(!0), f = c.attr("data-full"), h = f.split("-"),
                ...
                if ((Xa || !c.hasClass("dw-cal-day-diff")) && !1 !== b.trigger("onDayChange", [a.extend(Ab[f], {
                        ...
                        cell: this,
                        selected: i
                    })])) b.needsSlide = !1, V = !0, b.setDate(e, d, 0.2, !d, !0), z.divergentDayChange && (Ta = !0, h < z.getDate(ua, ma - pa, 1) ? J() : h > z.getDate(ua, ma - pa + na, 0) && G(), Ta = !1)
            }
            ...
            function S(b) {
                Ta && z.getDate(ua, ma, 1) <= z.getDate(z.getYear(ia) - 1, z.getMonth(ia) - Ia, 1) && a.mobiscroll.running ? u(++ua, ma, "next", qa, !0, !0, function () {
                    S(b)
                }) : Ta && !b.hasClass("dwb-d") &&
                    a.mobiscroll.running && u(z.getYear(ia), z.getMonth(ia) - Ia, "next", qa, !0, !0)
            }

            function K(b) {
                Ta && z.getDate(ua, ma, 1) >= z.getDate(z.getYear(Ba) + 1, z.getMonth(Ba) + pa, 1) && a.mobiscroll.running ? u(--ua, ma, "prev", qa, !0, !0, function () {
                    K(b)
            ...
            var L, n, v, P, W, r, U, X, E, Y, T, V, ba, Z, N, ea, ha, ga, ja, t, ca, la, $, I, ta, ka, Q, sa, oa, Ba,
                ia,
                Qa, ya, Ca, ua, ma, nb, ob, Db, Ja, Sa, Va, Za, Ta, na, Ga, Ia, pa, Xa, Ua, cb, rb, Fb = this, za = [],
                xa = [], fb = [], wa = {}, Ab = {}, Bb = function () {
                }, Vb = a.extend({}, b.settings), z = a.extend(b.settings, d, Vb),
                Wa = "full" == z.weekDays ? "" : "min" == z.weekDays ? "Min" : "Short",
                mb = z.weekCounter, Hb = z.layout || (/top|bottom/.test(z.display) ? "liquid" : ""),
                Ha = "liquid" == Hb && "bubble" !== z.display, yb = "modal" == z.display, Ya = z.rtl, gb = Ya ? -1 : 1,
                Gb = Ha ? null : z.calendarWidth, Ka = "vertical" == z.swipeDirection, ab = z.quickNav,
                qa = z.preMonths,
                Fa = "yearMonth" == z.navigation, Da = z.controls.join(","),
                bb = (!0 === z.tabs || !1 !== z.tabs && Ha) && 1 < z.controls.length,
                da = !bb && z.tabs === k && !Ha && 1 < z.controls.length, Ea = z.yearSuffix || "",
                ra = z.activeClass || "",
                pb = "dw-sel " + (z.activeTabClass || ""), ib = z.activeTabInnerClass || "", qb =
                "dwb-d " + (z.disabledClass || ""), Pa = "", va = "";
            ...
            b.prepareObj = O;
            b.refresh = function () {
                b.changing ? b.needsRefresh = true : b.isVisible() && ba && p(ua,
                    ma)
            };
            b.navigate = function (a, c) {
                var d, f, h = b.isVisible();
                if (c && h) C(a, true); else {
                    d = z.getYear(a);
                    f = z.getMonth(a);
                    if (h && (d != ua || f != ma)) {
            ...
            b.changeTab = function (c) {
                if (b._isVisible && wa[c] && Va != c) {
                    ...
                    if (Va === "calendar") {
                        L = b.getDate(true);
                        (L.getFullYear() !== Ca.getFullYear() || L.getMonth() !== Ca.getMonth() || L.getDate() !== Ca.getDate()) && C(L)
                    } else {
                        Ca = b.getDate(true);
            ...
            a.extend(P,
                {
                    ariaMessage: z.calendarText, onMarkupReady: function (d) {
                    var e, m, j = "";
                    r = d;
                    ...
                    if (z.maxDate) {
                        ...
                        ya = z.maxDate
                    } else ya = ia = new Date(z.endYear, 11,
                        31, 23, 59, 59);
                    ...
                    if (ba) {
                        ...
                        Ka = Ka && na < 2;
                        m = '<div class="dw-cal-btnw"><div class="' + (Ya ? "dw-cal-next-m" : "dw-cal-prev-m") +
                            ' dw-cal-prev dw-cal-btn dwb dwb-e"><div role="button" tabindex="0" class="dw-cal-btn-txt ' + (z.btnCalPrevClass || "") + '" aria-label="' + z.prevMonthText + '"></div></div>';
                        for (n = 0; n < na; ++n) m = m + ('<div class="dw-cal-btnw-m" style="width: ' + 100 / na + '%"><span role="button" class="dw-cal-month"></span></div>');
                        m = m + ('<div class="' + (Ya ? "dw-cal-prev-m" : "dw-cal-next-m") + ' dw-cal-next dw-cal-btn dwb dwb-e"><div role="button" tabindex="0" class="dw-cal-btn-txt ' + (z.btnCalNextClass || "") + '" aria-label="' + z.nextMonthText +
                            '"></div></div></div>');
                        Fa && (j = '<div class="dw-cal-btnw"><div class="' + (Ya ? "dw-cal-next-y" : "dw-cal-prev-y") + ' dw-cal-prev dw-cal-btn dwb dwb-e"><div role="button" tabindex="0" class="dw-cal-btn-txt ' + (z.btnCalPrevClass || "") + '" aria-label="' + z.prevYearText + '"></div></div><span role="button" class="dw-cal-year"></span><div class="' + (Ya ? "dw-cal-prev-y" : "dw-cal-next-y") + ' dw-cal-next dw-cal-btn dwb dwb-e"><div role="button" tabindex="0" class="dw-cal-btn-txt ' + (z.btnCalNextClass || "") + '" aria-label="' +
                            z.nextYearText + '"></div></div></div>');
                        if (ab) {
                            ka = z.getYear(Ba);
                            Q = z.getYear(ia);
                            sa = z.getMonth(Ba);
                        ...
                        Z = '<div class="mbsc-w-p dw-cal-c"><div class="dw-cal ' + (na > 1 ? " dw-cal-multi " : "") + (mb ? " dw-weeks " : "") + (Ka ? " mbsc-cal-vertical" : "") + (Xa ? "" : " dw-hide-diff ") + (z.highlightNow ? " dw-hl-now " : "") + (z.calendarClass || "") + '"><div class="dw-cal-header"><div class="dw-cal-btnc ' +
                            (Fa ? "dw-cal-btnc-ym" : "dw-cal-btnc-m") + '">' + (ta < $ || na > 1 ? j + m : m + j) + '</div></div><div class="dw-cal-body"><div class="dw-cal-m-c dw-cal-v"><div class="dw-cal-days-c">';
                        for (v = 0; v < na; ++v) {
                        ...
                        Z = Z + ('</div><div class="dw-cal-anim-c ' + (z.calendarClass || "") + '"><div class="dw-week-nrs-c ' + (z.weekNrClass ||
                    ...
                    a.each(z.controls, function (a, b) {
                        wa[b] && (e = e + ('<li role="tab" aria-controls="' +
                            (Fb.id + "_dw_pnl_" + a) + '" class="dw-cal-tab ' + (a ? "" : pb) + '" data-control="' + b + '"><a href="#" class="dwb-e dwb-nhl dw-i ' + (!a ? ib : "") + '">' + z[b + "Text"] + "</a></li>"))
                    });
                    e = e + "</ul></div>";
                    Sa.before(e);
                    X = a(".dw-cal-anim-c", r);
                    ...
                    if (ba) {
                        ...
                        t = new c.classes.ScrollView(X[0], {
                            ...
                            onAnimationEnd: function (a) {
                                (a = Math.round(((Ka ? a.posY : a.posX) - T) / Y) * gb) && u(ua, ma - a, a > 0 ? "prev" : "next", a > 0 ? a : -a)
                            }
                        })
                    }
                    la = a(".dw-cal-month", r);
                    ...
                    if (ab) {
                        ...
                        Pa = a(".dw-cal-month-c", r).on("webkitAnimationEnd animationend",
                            x);
                    ...
                    if (ab) {
                        ...
                        b.tap(a(".dw-cal-year", r), function () {
                        ...
                        b.tap(a(".dw-cal-month-s", r), function () {
                            !ca.scrolled && !a(this).hasClass("dwb-d") && b.navigate(z.getDate(ua, a(this).attr("data-val"),
                                1))
                        });
                        b.tap(a(".dw-cal-year-s", r), function () {
                            if (!Ua.scrolled) {
                    ...
                    if (Y) {
                        ...
                        if (Y !== m) {
                            ...
                            if (ab) {
                                ...
                                a.extend(Ua.settings, {contSize: f, snap: f, minScroll: (2 - ob) * f, maxScroll: -f});
                                a.extend(ca.settings, {contSize: f, snap: f, minScroll: -f, maxScroll: -f});
                                Ua.refresh();
                                ca.refresh();
                                va.hasClass("dw-cal-v") && Ua.scroll(cb)
                            }
                    ...
                    var c, d, e;
                    d = b.getDate(true);
                    if (V) c = "calendar"; else for (e in b.order) e &&
                    b.order[e] === a && (c = /[mdy]/.test(e) ? "date" : "time");
                    b.trigger("onSetDate", [{date: d, control: c}]);
                    C(d);
                    V = false
                }
                });
    ...
    (function (a, b) {
        ...
        l.presets.scroller.measurement = function (c) {
            ...
            function l(a) {
                var b = +a[T], c = L ? g(a[Y]) / P * (0 > b ? -1 : 1) : 0;
            ...
            function M(a) {
                ba = O(C.min, B, a);
                Z = O(C.max, B, a);
                L ? (N = 0 > ba ? Math.ceil(ba) : Math.floor(ba), ea = 0 > Z ? Math.ceil(Z) : Math.floor(Z), ha = f(ba),
                    ga = f(Z)) : (N = Math.round(ba), ea = Math.round(Z), ea = N + Math.floor((ea - N) / W) * W, t = N % W)
            }

            function w(a, b) {
                var c = +N, d = +ea, e = L ? 1 : W, f;
            ...
            function A(b) {
                if (n) {
                    var c = H.length, b = a.inArray(+b, H), e, f;
                    u.keys = [];
                    u.values = [];
                    for ($ = -50; 50 > $; $++) e = ($ + b) % c, f = H[0 > e ? c + e : e], e = Math.abs(Math.floor(($ + b) / c)), u.keys.push(Array(e).join(0 >
                    $ + b ? "-" : "+") + f), u.values.push("." + d(f, v))
                }
            }
            ...
            var D = a.extend({}, c.settings), C = a.extend(c.settings, k, D), D = {}, p = [[]], e = {}, F = {}, u = {},
                H = [], o = C.batch, G, J, S, K, R = C.sign, h = C.units && C.units.length,
                B = h ? C.defUnit || C.units[0] : "", x = C.unitNames || C.units, L = 1 > C.step, n = !1,
                v = L ? Math.max(C.scale, (C.step + "").split(".")[1].length) : 1, P = Math.pow(10, v),
                W = Math.round(L ? C.step * P : C.step), r, U, X, E = -1, Y, T, V, ba, Z, N, ea, ha, ga, ja, t = 0,
                ca = 0,
                la = {}, $, I = 0;
            c.setVal = function (b, d, e, f,
                                 g) {
            ...
            M(B);
            if (R) if (R = !1, h) for ($ = 0; $ < C.units.length; $++) 0 > O(C.min, B, C.units[$]) && (R = !0); else R = 0 > C.min;
            R && (p[0].push({values: ["-", "+"], label: C.signText}), E = I++);
            p[0].push(F);
            T = I++;
            if (L) {
                p[0].push(u);
                ...
                for ($ = ca; $ < P; $ += W) H.push($), u.keys.push($), u.values.push("." + d($, v));
                n = H.length > C.rows;
                Y = I++;
                r = Math.ceil(100 / W);
                C.invalid && C.invalid.length && (a.each(C.invalid, function (a,
                                                                              b) {
            ...
            if (h) {
                D = {keys: [], values: [], label: C.unitText};
                for ($ = 0; $ < C.units.length; $++) D.keys.push($), D.values.push(x[$]);
                p[0].push(D)
            }
            V = I;
            return {
                width: 55, wheels: p, showLabel: !1, formatValue: y, parseValue: function (b) {
                    var c = ((b || C.defaultValue) + "").split(" "), b = +c[0], d = [], e = "";
                    if (h) {
                        e = a.inArray(c[1], x);
                    ...
                    var r = c._tempWheelArray, v, o = [], t, p, I, P, y, u, x, F = +g(r[Y]), D = h ? C.units[r[V]] : "";
                    if (R && f === 0) {
                    ...
                    a.each(L ? e : C.invalid, function (b, c) {
                        if (R && v) if (c <= 0) c = Math.abs(c); else return;
                    ...
                    if (f !== Y && L) {
                        ...
                        d === j && a(".dw-li", u).each(function () {
                            x = g(a(this).attr("data-val"));
                            (v ? x > ha : x < ha) && a(this).removeClass("dw-v")
                        });
                        d === k && a(".dw-li", u).each(function () {
                            x = g(a(this).attr("data-val"));
                            (v ? x < ga : x > ga) && a(this).removeClass("dw-v")
                        });
                        a.each(C.invalid, function (b, c) {
                            I = i(O(c, B, D));
                            (p[0] ===
                                I[0] || p[1] === 0 && I[1] === 0 && I[2] === 0) && p[1] === I[1] && a(".dw-li", u).each(function () {
    ...
    (function (a) {
        var b = a.mobiscroll, l = b.presets.scroller,
            k = {min: 0, max: 100, defUnit: "N", units: ["N", "kp", "lbf", "pdl"]},
            c = {N: 1, kp: 9.80665, lbf: 4.448222, pdl: 0.138255};
        b.presetShort("force");
        l.force = function (b) {
            var f = a.extend({}, k, b.settings), i = [], s, q;
            if (f.units) for (q = 0; q < f.units.length; q++) s = f.units[q], c[s] && i.push(s);
            a.extend(b.settings, f, {
                sign: !1, units: i, unitNames: null, convert: function (a, b, f) {
                    return a * c[b] / c[f]
                }
            });
    ...
    (function (a, b, l, k) {
        var c = a.mobiscroll, j = a.extend, f = c.util, i = c.datetime, s = c.presets.scroller, q = {
        ...
        s.calendar = function (d) {
            ...
            function m(b) {
                ...
                var d = b.outerHeight(), f = b.outerWidth(), g = b.offset().top - a(".dw-cal-c", p).offset().top,
            ...
            function M(b, f) {
                ...
                if (h) {
                    ...
                    a.each(h, function (a, b) {
                        ...
                        var d = o,
                            e = '<li role="button" aria-label="' + b.text + (i ? ", " + n.fromText + " " + i : "") + (j ? ", " + n.toText + " " + j : "") + '" class="dw-cal-event"><div class="dw-cal-event-color" style="' + (k ? "background:" + k + ";" : "") + '"></div><div class="dw-cal-event-text">' +
                                (r.getTime && !E ? '<div class="dw-cal-event-time">' + c.datetime.formatDate(n.timeFormat, r) + "</div>" : "") + b.text + "</div>",
                            f;
                        if (b.start && b.end) {
                            f = n.labelsShort;
                            var h = Math.abs(b.end - b.start) / 1E3, m = h / 60, l = m / 60, v = l / 24, p = v / 365;
                            f = '<div class="dw-cal-event-dur">' + (45 > h && Math.round(h) + " " + f[5].toLowerCase() || 45 > m && Math.round(m) + " " + f[4].toLowerCase() || 24 > l && Math.round(l) + " " + f[3].toLowerCase() || 30 > v && Math.round(v) + " " + f[2].toLowerCase() || 365 > v && Math.round(v / 30) + " " + f[1].toLowerCase() || Math.round(p) + " " + f[0].toLowerCase()) +
                                "</div>"
                        } else f = "";
                        o = d + (e + f + "</li>")
                    });
            ...
            function y(a) {
                T = {};
                if (a && a.length) for (K = 0; K < a.length; K++) T[A(a[K])] =
                    a[K]
            }
            ...
            B = j({}, d.settings);
            var n = j(d.settings, q, B), v = "dw-sel dw-cal-day-ev", P = "dw-cal-day-hl", W = n.activeClass || "",
                r = n.multiSelect || "week" == n.selectType, U = f.isNumeric(n.multiSelect) ? n.multiSelect : Infinity,
                X = n.markedDisplay, E = !0 === n.events || !0 === n.markedText, Y = 0, T = {}, V = a.isArray(n.events),
                ba = V ? j(!0, [], n.events) : [];
            B = s.calbase.call(this, d);
            C = j({}, B);
            S = n.firstSelectDay === k ? n.firstDay : n.firstSelectDay;
            if (n.selectedValues) for (K = 0; K < n.selectedValues.length; K++) T[A(n.selectedValues[K])] =
                n.selectedValues[K];
            V && a.each(ba, function (a, b) {
                b._id === k && (b._id = Y++)
            });
            ...
            d.getDayProps = function (b) {
                for (var c = r ? T[b] !== k : V ? b.getTime() === (new Date).setHours(0, 0, 0, 0) : k, d = R[b] ? R[b][0] : !1, e = u[b] ? u[b][0] : !1, f = d || e, d = d.text || (e ? u[b].length + " " + (1 < u[b].length ? n.eventsText : n.eventText) : 0), e = R[b] || u[b] || [], h = f.color, i = E && d ? g(h) : "", m = "", j = '<div class="dw-cal-day-m"' + (h ? ' style="background-color:' + h + ";border-color:" + h + " " + h + ' transparent transparent"' :
                ...
                return {
                    ...
                    ariaLabel: E || V ? d : "",
                    markup: E && d ?
                        '<div class="dw-cal-day-txt-c"><div class="dw-cal-day-txt ' + (n.eventTextClass || "") + '" title="' + a("<div>" + d + "</div>").text() + '"' + (h ? ' style="background:' + h + ";color:" + i + ';text-shadow:none;"' : "") + ">" + m + d + "</div></div>" : E && m ? '<div class="dw-cal-day-ic-c">' + m + "</div>" : f ? j : ""
                }
            };
            ...
            V && (d.addEvent = function (b) {
                ...
                var b;
                return a ? (a.setHours(0, 0, 0, 0), b = d.prepareObj(ba, a.getFullYear(), a.getMonth()),
                    b[a] ? l(b[a]) : []) : j(!0, [], ba)
            ...
            j(B, {
                ...
                onBeforeShow: function () {
                    ...
                    if (n.counter && r) n.headerText = function () {
                        var b = 0, c = n.selectType == "week" ? 7 : 1;
                        a.each(T, function () {
                            b++
                        });
                        b = Math.round(b / c);
                ...
                onDayChange: function (b) {
                    var c = b.date, e = A(c), g = a(b.cell), b = b.selected;
                    if (V) {
                        w();
                        g.hasClass("dw-cal-day-ev") || setTimeout(function () {
                            d.changing ? x = {d: e, full: g.attr("data-full")} : M(e, g)
                        }, 10)
                    } else if (r) if (n.selectType == "week") {
                        var h, i, m = e.getDay() - S, m = m < 0 ? 7 + m : m;
                        n.multiSelect || (T = {});
                        for (h = 0; h < 7; h++) {
                            i = new Date(e.getFullYear(),
                                e.getMonth(), e.getDate() - m + h);
    ...
    (function (a) {
        var b = a.mobiscroll, l = b.presets.scroller, k = {
            min: 0,
            max: 100,
            defUnit: "kph",
            units: ["kph", "mph", "mps", "fps", "knot"],
            unitNames: {kph: "km/h", mph: "mi/h", mps: "m/s", fps: "ft/s", knot: "knot"}
        }, c = {kph: 1, mph: 1.60934, mps: 3.6, fps: 1.09728, knot: 1.852};
        b.presetShort("speed");
        l.speed = function (b) {
            var f = a.extend({}, k, b.settings), i = [], s = [], q, d;
            if (f.units) for (d = 0; d < f.units.length; d++) q = f.units[d], c[q] && (i.push(q), s.push(f.unitNames[q] || q));
            a.extend(b.settings, f, {
                sign: !1, units: i, unitNames: s, convert: function (a, b,
                                                                     d) {
                    return a * c[b] / c[d]
                }
            });
    ...
    (function (a) {
        ...
        l.temperature = function (b) {
            var i = a.extend({}, k, b.settings), s = [], q = [], d, g;
            if (i.units) for (g = 0; g < i.units.length; g++) d = i.units[g], c[d] && (s.push(d), q.push(i.unitNames[d] || d));
            a.extend(b.settings, i, {
                sign: !0, units: s, unitNames: q, convert: function (a, b, c) {
                    return j[b + "2" + c](a)
                }
            });
            return l.measurement.call(this, b)
    ...
    (function (a) {
        ...
        l.mass = function (b) {
            var f = a.extend({}, k, b.settings), i = [], s = [], q, d;
            if (f.units) for (d = 0; d < f.units.length; d++) q = f.units[d], c[q] && (i.push(q), s.push(f.unitNames[q] ||
                q));
            a.extend(b.settings, f, {
                sign: !1, units: i, unitNames: s, convert: function (a, b, d) {
                    return a * c[b] / c[d]
                }
            });
            return l.measurement.call(this, b)
    ...
    (function (a, b) {
        ...
        l.presets.scroller.timespan = function (c) {
            ...
            function f(a, b) {
                var c = !1, d = S[K[a] - 1] || 1, f = G[a], h = f.wheel, i = f.prefix;
                A = 0;
                y = f.until;
                a == R && (A = Math.max(p[a],
                    b[a] - 50 * d), y = Math.min(e[a], A + 100 * d), g = A + 5 * d, O = y - 5 * d);
                h.keys = [];
                h.values = [];
                h.label = f.label;
                H.match(RegExp(f.re + f.re, "i")) && (c = !0);
                for (s = A; s <= y; s += d) h.keys.push(s), h.values.push((i || "") + (10 > s && c ? "0" : "") + s + '<span class="dwtlbl">' + f.label + "</span>")
            }
            ...
            var s, q, d, g, O, m, M, w, A, y, D, C, p, e, F = a.extend({}, c.settings), u = a.extend(c.settings, k, F),
                H = u.wheelOrder, F = u.useShortLabels ? u.labelsShort : u.labels,
                o = "years,months,days,hours,minutes,seconds".split(","),
                G = {
                    years: {ord: 0, index: 6, until: 10, limit: 31536E6, label: F[0], re: "y", wheel: {}},
                    months: {ord: 1, index: 5, until: 11, limit: 2592E6, label: F[1], re: "m", wheel: {}},
                    days: {ord: 2, index: 4, until: 31, limit: 864E5, label: F[2], re: "d", wheel: {}},
                    hours: {ord: 3, index: 3, until: 23, limit: 36E5, label: F[3], re: "h", wheel: {}},
                    minutes: {ord: 4, index: 2, until: 59, limit: 6E4, label: F[4], re: "i", wheel: {}},
                    seconds: {ord: 5, index: 1, until: 59, limit: 1E3, label: F[5], re: "s", wheel: {}}
                }, J = [], S = u.steps || [], K = {}, R = "seconds", h = 0, B = u.defaultValue || Math.max(u.minTime,
                Math.min(0, u.maxTime)), x = [[]];
            d = 0;
            w = j(d);
            p = j(u.minTime);
            e = j(u.maxTime);
            a(o).each(function (a, b) {
                q = H.search(RegExp(G[b].re, "i"));
                -1 < q && (J.push({o: q, v: b}), G[b].index > G[R].index && (R = b))
            });
            J.sort(function (a, b) {
                return a.o > b.o ? 1 : -1
            });
            ...
            return {
                mode: "scroller", showLabel: !0, wheels: x, parseValue: function (b) {
                    ...
                    d = i(r);
                    q = j(d);
                    if (l === h || !m && (r[h] < g || r[h] > O)) if (f(R, q), D !== A || C !==
                        y) w = r[h], M = setTimeout(function () {
                        D = A;
                        C = y;
                        m = !0;
                        r[h] = w;
                    ...
                    a(".dwwl" + h, b).on("mousedown touchstart", function () {
                        clearTimeout(M)
                    })
                }
            }
    ...
    (function (a, b, l, k) {
        var c = a.extend, j = a.mobiscroll, f = j.classes;
        f.MenuStrip = function (i, l) {
            ...
            function d(b, c) {
                if (b.length) {
                    var d = b.offset().left, e = b[0].offsetLeft, f = b.outerWidth(), h = y.offset().left;
                    A = b;
                    c === k && (c = !H);
            ...
            function g(a) {
                a.addClass(S).attr("data-selected",
            ...
            function M() {
                ...
                n.children().each(function (b) {
                    var c, d = a(this), f = J && "true" == d.attr("data-selected"),
            ...
            var A, y, D, C, p, e, F, u, H, o, G, J, S, K, R, h, B, x, L = this, n = a(i);
            ...
            L.init = function (c) {
                ...
                n.css("display", "").addClass("mbsc-ms " +
                    (h.groupClass || ""));
                M();
                x("onMarkupReady", [y]);
                n.height(n.height());
        ...
        f.MenuStrip.prototype = {
            ...
            _hasDef: !0,
            _hasTheme: !0,
            _defaults: {type: "options", display: "inline", layout: "liquid"}
        };
    ...
    (function (a) {
        var b = a.mobiscroll, l = b.classes;
        l.Widget = function (b, c, j) {
            function f(b) {
                a(".dwcc", b).append();
                !a(".dwcc", b).hasClass("mbsc-wdg-c") && a.mobiscroll.running && (a(".dwcc", b).addClass("mbsc-wdg-c").append(s.show()), a(".mbsc-w-p", b).length || a(".dwcc", b).addClass("mbsc-w-p"))
            }
            ...
            q._markupInserted = function (a) {
                "inline" == i.display && f(a);
                a.trigger("mbsc-enhance", [{theme: i.theme, lang: i.lang}])
            };
            ...
            q._processSettings = function () {
                i = q.settings;
                q.buttons.close = {text: i.closeText, handler: "cancel"};
                q.buttons.ok = {text: i.okText, handler: "set"};
        ...
        l.Widget.prototype = {
            ...
            _hasContent: !0,
            _class: "widget",
            _defaults: a.extend({}, l.Frame.prototype._defaults, {okText: "OK"})
        };
        ...
        l.presets.scroller.timer = function (c) {
            ...
            function f(b) {
                ...
                if (ba && L[E].index > L.days.index) {
                    ...
                    for (d = x.length; 0 < d; d--) e = x[d - 1], f = L[e], h = x[a.inArray(e, x) - 1], L[h] && 0 > c[e] && (c[h]--, c[e] += "months" == h ? 32 - (new Date(g.getFullYear(),
                        g.getMonth(), 32)).getDate() : f.until + 1);
            ...
            function i(b, c) {
                var f = 1, h = L[b], g = h.wheel, i = h.prefix, m = L[x[a.inArray(b, x) - 1]];
                G = 0;
                J = h.until;
                ...
                if (h.index <= L[E].index && (!m || m.limit > X)) {
                    ...
                    g.values = [];
                    g.label = h.label || "";
                    X >= h.limit && (f = Math.max(Math.round(X / h.limit),
                        1), O = f * h.limit);
                    for (d = G; d <= J; d += f) g.keys.push(d), g.values.push((i || "") + (10 > d ? "0" : "") + d + '<span class="dwtlbl">' + (h.label || "") + "</span>")
                }
            }
            ...
            var d, g, O, m, M, w, A, y, D, C, p, e, F, u, H, o, G, J, S, K, R = a.extend({}, c.settings),
                h = a.extend(c.settings, k, R), B = h.useShortLabels ? h.labelsShort : h.labels,
                x = "years,months,days,hours,minutes,seconds,fract".split(","), L = {
                    years: {index: 6, until: 10, limit: 31536E6, label: B[0], wheel: {}},
                    months: {index: 5, until: 11, limit: 2592E6, label: B[1], wheel: {}},
                    days: {index: 4, until: 31, limit: 864E5, label: B[2], wheel: {}},
                    hours: {index: 3, until: 23, limit: 36E5, label: B[3], wheel: {}},
                    minutes: {index: 2, until: 59, limit: 6E4, label: B[4], wheel: {}},
                    seconds: {index: 1, until: 59, limit: 1E3, label: B[5], wheel: {}},
                    fract: {
                        index: 0, until: 99,
                        limit: 10, label: B[6], prefix: ".", wheel: {}
                    }
                }, n = {}, v = [], P = 0, W = !1, r = !0, U = !1, X = Math.max(10, 1E3 * h.step), E = h.maxWheel,
                Y = h.locked || ba, T = (a.isArray(h.controls) ? h.controls : []).join(","), V = h.targetTime,
                ba = V && V.getTime !== b, Z = "jqm" == h.theme, N = [[]];
            c.start = function () {
                r && c.reset();
                if (!W && (q(), U || !(y >= A))) W = !0, r = !1, M = new Date, m = y, h.readonly = !0, c.setValue(l(D ? y : A - y), !0, 0.1), g = setInterval(function () {
                    y = new Date - M + m;
                    c.setValue(l(D ? y : A - y), !0, 0.1);
                    !U && y + O >= A && (clearInterval(g), setTimeout(function () {
                        c.stop();
                        y = A;
                        c.setValue(l(D ?
                            y : 0), !0, 0.1);
                ...
                }, O), a(".dwwr", C).addClass("dw-running dw-locked"), a(".dw-timer-st", C).removeClass(h.btnStartClass || "").addClass(h.btnStopClass || "").attr("title", h.stopText).find(".dwb-txt").text(h.stopText), c.trigger("onStart", [])
            };
            c.stop = function () {
                W && (W = !1, clearInterval(g), y = new Date - M + m, a(".dwwr", C).removeClass("dw-running"), a(".dw-timer-st", C).removeClass(h.btnStopClass || "").addClass(h.btnStartClass || "").attr("title", h.startText).find(".dwb-txt").text(h.startText),
                    c.trigger("onStop", [y]))
            };
            c.reset = function () {
                c.stop();
            ...
            c.setElapsedTime = c.setEllapsedTime = function (a, b) {
                r || (m = y = a, M = new Date, c.setValue(l(D ? y : A - y), !0,
                    0.1, !1, b))
            };
            q(!0);
            !E && !A && (E = "minutes");
            E || a(x).each(function (a, b) {
                if (!E && A >= L[b].limit) return E = b, !1
            });
            o = f(A);
            a(x).each(function (a, b) {
                i(b, o)
            ...
            return {
                wheels: N, headerText: !1, readonly: Y, parseValue: function () {
                    return l(D ? 0 : A)
                }, formatValue: function (b) {
                    var c = "", d = 0;
                    ...
                    var m, j, k = 0, l = c._tempWheelArray,
                        d = !1;
                    r && h !== b && (V = 0, a(x).each(function (a, b) {
                        n[b] && (V += L[b].limit * l[k], k++)
                    }), V /= 1E3, q(!0));
                    if (r && 0 === h) d = !0, m = f(A); else if (!u && (l[0] < p || l[0] > e)) m = f(D ? y : A - y), d = !0;
                    if (d && (i(E, m), S !== G || K !== J)) j = l[0], H = setTimeout(function () {
                        S = G;
                        K = J;
                        u = true;
                        l[0] = j;
                    ...
                    var e = T.match(/start/), f = T.match(/reset/) && !ba, g = T.match(/lap/) && !ba,
                        i = "inline" !== h.display;
                    if (e || f || g || i) a(".dwwr", b).addClass("dw-timer-btns").append('<div class="dwbc">' + (e ? '<span class="dwbw dwbgr dwbgrf' + (!f && !g ? " dwbgrl" : "") + '"><a href="#" role="button" class="dwb-e dwb dw-timer-st ' + (W ? h.btnStopClass || "" : h.btnStartClass || "") + '"' +
                        ...
                        "") + ">" + h.hideText + "</a></span>" : "") + "</div>"), c.tap(a(".dw-timer-st", b), function () {
                        W ? c.stop() : c.start()
                    }, !0), c.tap(a(".dw-timer-r", b), function () {
                        c.reset()
                    }, !0), c.tap(a(".dw-timer-l", b), function () {
                        c.lap()
                    }, !0), c.tap(a(".dw-timer-cl", b), function () {
                        c.hide()
                    }, !0)
                }, onPosition: function (b) {
    ...
    (function (a, b) {
        ...
        function c(a) {
            var b, c, d;
            b = a.h;
            var f = 255 * a.s / 100, a = 255 * a.v / 100;
            if (0 === f) b = c = d = a; else {
                var f = (255 - f) * a / 255, g = (a - f) * (b % 60) / 60;
                360 == b && (b = 0);
                60 > b ? (b = a, d = f, c = f + g) : 120 > b ? (c = a, d = f, b = a - g) : 180 > b ? (c = a, b = f, d = f + g) : 240 >
                b ? (d = a, b = f, c = a - g) : 300 > b ? (d = a, c = f, b = f + g) : 360 > b ? (b = a, c = f, d = a - g) : b = c = d = 0
            }
            return {r: b, g: c, b: d}
        }
        ...
        var q = a.mobiscroll, d = q.util.prefix,
            g = q.presets.scroller, O = {
                preview: !0,
                previewText: !0,
                label: "Color",
                refineLabel: "Refine",
        ...
        g.color = g.colorpicker = function (g) {
            ...
            function A(a) {
                a = w(a);
                return "rgb" === v ? (a = k(a), Math.round(a.r) + "," + Math.round(a.g) + "," + Math.round(a.b)) : "hsv" === v ? (a = s(a), Math.round(a.h) + "," + Math.round(a.s) + "," + Math.round(a.v)) :
                    a
            }
            ...
            function C(b, d) {
                ...
                1 !== d && 2 !== d && D(a(".dwwl1 .dw-ul", b), f({h: e[0], s: 0, v: 100}), f({
                    h: e[0],
                    s: 100,
                    v: 100
                }));
                ...
                if (P) {
                    var h = c({h: e[0], s: e[1], v: e[2]}), h = 0.299 * h.r + 0.587 * h.g + 0.114 * h.b;
            ...
            function p() {
                var a = 0, b = {keys: [], values: [], labels: [], label: r},
                    c = {keys: [], values: [], labels: [], label: U}, d = {keys: [], values: [], labels: [], label: X};
            ...
            function e(b, c, d) {
                var e, f, g = {keys: [], values: [], label: c || B.label};
                a.each(b, function (a, b) {
                    e = w(b);
                    f = A(b);
                    g.keys.push(f);
                    g.values.push('<div class="dw-cbc"><div class="dw-cb' + ("circle" === B.style ? " dw-cb-circle" : "") + '" style="background:' +
                        e + '"></div></div>' + f);
                    d && (J[f] = d)
                });
                return g
            ...
            function F(a, b, c) {
                ...
                for (; d <= c; d += b) g.push(f(i({h: e, s: a, l: Math.max(0, Math.min(d, 100))})));
                return g
            }

            var u, H, o, G, J = {}, S = {}, K = {}, R, h = a.extend({}, g.settings), B = a.extend(g.settings, O, h),
                x = !B.colors, h = a.isArray(B.colors) ? B.colors : [B.colors], L = B.defaultValue || h[0],
                n = B.refine && 1 < h.length, v = B.format, P = x && B.preview, W = B.previewText, r = B.hueText,
                U = B.saturationText, X = B.valueText;
            !x && 1 == h.length && (h = F(s(w(h[0])), B.step, B.nr));
            x ? (G = p(), K = {
                width: 70,
                height: 15,
                rows: 13,
                ...
                timeUnit: 0.05,
                showLabel: !0
            }) : n ? (a.each(h, function (a, b) {
                H = w(b);
                o = A(b);
                S[o] = e(F(s(H), B.step, B.nr), B.refineLabel, o);
                a || (u = S[o])
            }), G = [[e(h), u]]) : (K = {width: 180}, G = [[e(h)]]);
            return a.extend({
                wheels: G, parseValue: function (a) {
                    if (x) {
                        if (a = a || L) {
                            if (v == "hsv") {
                                a = a.split(",");
                                a = {h: q(a[0]), s: q(a[1]), v: q(a[2])}
                            } else if (v == "rgb") {
                                a = a.split(",");
                                a = j({r: q(a[0]), g: q(a[1]), b: q(a[2])})
                            } else {
                                a =
                                    a.replace("#", "");
                    ...
                    return [a || A(L)]
                }, formatValue: y, onBeforeShow: function () {
        ...
        q.colorpicker = {hsv2hex: f, hsv2rgb: c, rgb2hsv: j, rgb2hex: l, hex2rgb: k, hex2hsv: s}
    })(jQuery);
    (function (a, b) {
        var l = a.mobiscroll, k = l.presets.scroller, c = l.datetime, j = l.util.testTouch,
        ...
        k.range = k.rangepicker = function (i) {
            ...
            function q(b, d) {
                var f = !0;
                if (b && e && F && (F - e > h.maxRange - 1 && (f = !1, K ? e = new Date(F - h.maxRange + 1) : F = new Date(+e + h.maxRange - 1)), F - e < h.minRange - 1)) f = !1, K ? e = new Date(F -
                    h.minRange + 1) : F = new Date(+e + h.minRange - 1);
                if (!e || !F) f = !1;
                if (d) {
                    var g, i, j, k, l, n = 0, o = x || !K ? " dw-cal-day-hl dw-cal-sel-start" : " dw-cal-sel-start",
                        q = x || K ? " dw-cal-day-hl dw-cal-sel-end" : " dw-cal-sel-end";
                    C = e ? c.formatDate(w, e, h) : "";
                    p = F ? c.formatDate(w, F, h) : "";
                    if (m && (a(".dw-drv0", m).html(C || "&nbsp;"), a(".dw-drv1", m).html(p || "&nbsp;"), g = e ? new Date(e) : null, j = F ? new Date(F) : null, !g && j && (g = new Date(j)), !j && g && (j = new Date(g)), l = K ? j : g, a(".dw-cal-table .dw-sel .dw-i", m).removeClass(L), a(".dw-cal-table .dw-cal-day-hl",
                            m).removeClass(v), a(".dw-cal-table .dw-sel", m).removeClass("dw-sel dw-cal-sel-start dw-cal-sel-end").removeAttr("aria-selected"), g && j)) {
                        i = g.setHours(0, 0, 0, 0);
                        for (k = j.setHours(0, 0, 0, 0); j >= g && 84 > n;) a('.dw-cal-day[data-full="' + l.getFullYear() + "-" + l.getMonth() + "-" + l.getDate() + '"]', m).addClass("dw-sel" + (l.getTime() === i ? o : "") + (l.getTime() === k ? q : "")).attr("aria-selected", "true").find(".dw-i ").addClass(L), l.setDate(l.getDate() + (K ? -1 : 1)), n++
                    }
                }
                return f
            }
            ...
            var O, m, M, w, A, y, D, C, p, e, F, u, H, o, G, J = i._startDate, S = i._endDate, K = 0;
            A = new Date;
            var R = a.extend({}, i.settings), h = a.extend(i.settings, f, R), B = h.anchor, x = h.rangeTap,
                L = h.activeClass || "", n = "dwb-d " + (h.disabledClass || ""), v = "dw-cal-day-hl",
                P = null === h.defaultValue ? [] : h.defaultValue ||
            ...
            h.startInput && (H = a(h.startInput).prop("readonly"), i.attachShow(a(h.startInput).prop("readonly", !0), function () {
                K = 0;
            ...
            i.getDayProps = function (a) {
                var b = e ? new Date(e.getFullYear(), e.getMonth(),
                    e.getDate()) : null, c = F ? new Date(F.getFullYear(), F.getMonth(), F.getDate()) : null;
                return {
            ...
            a.extend(A, {
                highlight: !1, divergentDayChange: !1, formatValue: function () {
                    ...
                    h.defaultValue = P[0];
                    J = h.startInput ? a(h.startInput).val() ? c.parseDate(w,
                        a(h.startInput).val(), h) : P[0] : b[0] ? c.parseDate(w, b[0], h) : P[0];
                    h.defaultValue = P[K];
    ...
    (function (a, b) {
        ...
        l.presets.scroller.rating = function (c) {
            var j = a.extend({}, c.settings), f = a.extend(c.settings, k, j), i = a(this), j = this.id + "_dummy",
                s = a('label[for="' + this.id + '"]').attr("for", j),
                q = f.label !== b ? f.label : s.length ? s.text() : i.attr("name"), d = f.defaultValue, s = [[]],
                q = {keys: [], values: [], labels: [], label: q}, g = {}, O = [], m, M = !1, w, A, y, D, C, p,
                e = "grade" ===
                f.style ? "circle" : "icon";
            i.is("select") && (f.values = {}, a("option", i).each(function () {
                f.values[a(this).val()] = a(this).text()
            }), a("#" + j).remove());
            if (a.isArray(f.values)) for (w = 0; w < f.values.length; w++) y = +f.values[w], isNaN(y) && (y = w + 1, M = !0), O.push({
                order: y,
                key: f.values[w],
                value: f.values[w]
            }); else if (a.isPlainObject(f.values)) for (A in w = 1, M = !0, f.values) y = +A, isNaN(y) && (y = w), O.push({
                order: y,
                key: A,
                value: f.values[A]
            }), w++; else for (w = 1; w <= f.values; w++) O.push({order: w, key: w, value: w});
            f.showText === b && M && (f.showText =
                !0);
            ...
            for (w = 0; w < O.length; w++) {
                ...
                for (A = C + 1; A <= p; A++) M += '<span class="mbsc-rating-' + e + ("circle" === e ? " mbsc-rating-circle-unf" : " mbsc-ic mbsc-ic-" + (f.icon.empty ?
            ...
            return {
                anchor: m, wheels: s, headerText: !1, formatValue: function (a) {
                    return g[a[0]]
                }, parseValue: function (a) {
    ...
    (function (a) {
        a.each(["date", "time", "datetime"], function (b, l) {
            a.mobiscroll.presetShort(l)
        })
    })(jQuery);
    (function (a, b) {
        var l = a.mobiscroll, k = l.util, c = k.isString, j = {
            batch: 40,
            inputClass: "",
            invalid: [],
            rtl: !1,
        ...
        l.presets.scroller.select = function (f) {
            function i() {
                ...
                ba ? a.each(v.data, function (a, h) {
                    ...
                    la[b] = {text: this.label, value: b, options: [], index: b};
                    D.push(la[b]);
                    a("option", this).each(function (a) {
                        e = {value: this.value, text: this.text, index: ea ? a : h++, group: b};
                        ca[this.value] = e;
                        H.push(e);
                        la[b].options.push(e);
                ...
                ha && (H = [], h = 0, a.each(la, function (b, c) {
                    g = "__group" + b;
            ...
            function l(a, c, d, e, f, g, i) {
                var j = [], k = [], e = Math.max(0, (d[e] !== b ? d[e].index : 0) - P),
                    m = Math.min(c.length - 1, e + 2 * P);
                if (h[f] !== e || B[f] !== m) {
                    for (d = e; d <= m; d++) k.push(c[d].text), j.push(c[d].value);
                    R[f] = !0;
                    x[f] = e;
                    L[f] = m;
                    c = {multiple: g, values: k, keys: j, label: i};
                    W ? a[0][f] = c : a[f] = [c]
                } else R[f] = !1
            }
            ...
            function m() {
                ...
                if (U) {
                    b = [];
                    for (c in t) a.push(ca[c] ? ca[c].text : ""), b.push(c);
                    a = a.join(", ")
                } else b = G, a = ca[G] ? ca[G].text : "";
                f._tempValue = b;
                u.val(a);
                r.val(b)
            }
            ...
            function M(a) {
                ...
                if (U && a.closest(".dwwl").hasClass("dwwms")) return a.hasClass("dw-v") && (c ? (a.removeClass(T).removeAttr("aria-selected"), delete t[b]) : k.objectToArray(t).length < X && (a.addClass(T).attr("aria-selected", "true"), t[b] = b)), !1;
                a.hasClass("dw-w-gr") && (p = a.attr("data-val"))
            }

            var w, A, y, D, C, p, e, F, u, H, o, G, J, S, K, R = {}, h = {}, B = {}, x = {}, L = {},
                n = a.extend({}, f.settings), v = a.extend(f.settings,
                j, n), P = v.batch, n = v.layout || (/top|bottom/.test(v.display) ? "liquid" : ""), W = "liquid" == n,
                r = a(this), U = v.multiple || r.prop("multiple"), X = k.isNumeric(v.multiple) ? v.multiple : Infinity,
                E = this.id + "_dummy";
            F = a('label[for="' + this.id + '"]').attr("for", E);
            var Y = v.label !== b ? v.label : F.length ? F.text() : r.attr("name"),
                T = "dw-msel mbsc-ic mbsc-ic-" + v.checkIcon, V = v.readonly, ba = !!v.data,
                Z = ba ? !!v.group : a("optgroup", r).length;
            F = v.group;
            var N = Z && F && !1 !== F.groupWheel, ea = Z && F && N && !0 === F.clustered,
            ...
            r.addClass("dw-hsel").attr("tabindex",
            ...
            f.getValue = O;
            return {
                width: 50, layout: n, headerText: !1,
                anchor: u, confirmOnTap: N ? [!1, !0] : !0, formatValue: function (a) {
                    var b, c = [];
                    if (U) {
                    ...
                    g(a === b ? r.val() : a);
                    return N ? [y, G] : [G]
                }, onValueTap: M, onValueFill: m, onBeforeShow: function () {
                    ...
                    var l = k[e], n = k[o], r = a(".dw-ul", c).eq(e), s = a(".dw-ul",
                        c).eq(o);
    ...
    (function (a) {
        var b = a.mobiscroll, l = b.presets.scroller,
            k = {min: 0, max: 100, defUnit: "km", units: "m,km,in,ft,yd,mi".split(",")}, c = {
                mm: 0.001,
                cm: 0.01,
                dm: 0.1,
                m: 1,
    ...
    (function (a) {
        function b(b, d) {
            var f = s(d, "X", !0), i = s(d, "Y", !0), j = b.offset(), k = f - j.left, w = i - j.top,
                k = Math.max(k, b[0].offsetWidth - k), w = Math.max(w, b[0].offsetHeight - w),
        ...
        var k, c, j = a.mobiscroll, f = j.util, i = f.testTouch, s = f.getCoord;
        j.themes.material = {
            addRipple: b, removeRipple: function () {
                l(c)
            }, initRipple: function (f, d, g, j) {
                var m, M;
                f.off(".mbsc-ripple").on("touchstart.mbsc-ripple mousedown.mbsc-ripple", d, function (c) {
                    ...
                    if (k && 9 < Math.abs(s(a, "X") - m) || 9 < Math.abs(s(a, "Y") - M)) l(c), k = null
    ...
    (function (a) {
        ...
        a.mobiscroll.themes.listview["material-dark"] = {
            baseTheme: "material", onItemActivate: function (b, l) {
        ...
        a.mobiscroll.themes.form["material-dark"] = {
            baseTheme: "material", onControlActivate: function (b, l) {
                var k;
        ...
        a.mobiscroll.themes.progress["material-dark"] = {baseTheme: "material"}
    })(jQuery);
    (function (a) {
        ...
        a.mobiscroll.themes.progress["mobiscroll-dark"] = {baseTheme: "mobiscroll"}
    })(jQuery);
    (function (a) {
        ...
        a.mobiscroll.themes.form["android-holo-light"] =
            {baseTheme: "android-holo"};
        a.mobiscroll.themes.progress["android-holo-light"] = {baseTheme: "android-holo"}
    })(jQuery);
    (function (a) {
        a.mobiscroll.themes.frame["wp-light"] = {
            ...
            onMarkupInserted: function (b, l) {
                ...
                if ("clickpick" != l.settings.mode) a(".dwwl", b).on("touchstart mousedown wheel mousewheel", function (i) {
                    if (!("mousedown" === i.type && c || (a.isArray(f.readonly) ? f.readonly[a(".dwwl", b).index(this)] : f.readonly))) c = "touchstart" === i.type, k = !0, j = a(this).hasClass("wpa"), a(".dwwl", b).removeClass("wpa"), a(this).addClass("wpa")
                }).on("touchmove mousemove", function () {
                    k = !1
                }).on("touchend mouseup",
                    function (b) {
        ...
        a.mobiscroll.themes.progress["wp-light"] = {baseTheme: "wp"}
    })(jQuery);
    (function (a) {
        a.mobiscroll.themes.frame["sense-dark"] = {
            ...
            onMarkupReady: function (b, l) {
                var k = l.settings, c = k.height, k = k.rows;
                a(".dww", b).height(k *
                    c - 40);
                a(".dw-ul", b).css("margin-top", k / 2 * c - c / 2 - 20 + "px");
                a(".dwwms .dw-ul", b).css("margin-top", "-20px");
                a(".dwwb", b).css({height: c - 20 + "px", lineHeight: c - 20 + "px"})
            }
        };
