...
{
    $captcha_path = base_url('assets/plugins/kcaptcha');
    $html = "\n" . '<script>var g5_captcha_url  = "' . $captcha_path . '";</script>';
    $html .= "\n" . '<script>var g5_captcha_path = "' . $captcha_path . '";</script>';
    $html .= "\n" . '<script src="' . $captcha_path . '/kcaptcha.js"></script>';
    $html .= "\n" . '<fieldset id="captcha" class="' . $class . '">';
    $html .= "\n" . '<div class="row">
                        <div class="col-md-12" style="display:flex">
                            <img src="#" alt="" id="captcha_img">
                            <button type="button" id="captcha_reload">
                                <img onerror = "noExitImg(this)" src="' . base_url('assets/plugins/kcaptcha/img/Refresh.png') . '" alt="">
                            </button>
                            <input style="flex:1" type="text" name="captcha_key" id="captcha_key" required class="captcha_box required form-control" size="6" maxlength="6">
                        </div>
                        ';
    $html .= "\n" . '</div></fieldset>';
