...
<body>
    ...
    <div class="hgroup">
        ...
        <h2>{{__('lang.당신은 수정권한이 없습니다')}} <br>{{__('lang.보안을 위하여 이러한 요청을 차단합니다')}} {{__('lang.관리자에게 문의하여 주십시오')}}</h2>
        <a href="{{ route('home') }}">
            <button type="button" class="btn btn-primary button-alignment">첫페이지</button>
        </a>
    </div>
    <!-- global js -->
