                    ...
                    <div class="col-sm-12 col-md-12 margin-box">
                        @if(Sentinel::check())
                            <div class = "comment-write-rect">
                                <form method="POST" id = "saveForm"  action="{{url("/question/ajaxSaveReview")}}" accept-charset="UTF-8" class="bf" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group {{ $errors->has('comment') ? 'has-error' : '' }}">
                                        <textarea class="form-control input-lg no-resize" required="required" style="height: 200px" placeholder="{{__('lang.글을 입력해주십시오.')}}"  name="content" cols="50" rows="10">{!! $info['content'] !!}</textarea>
...
@section('footer_scripts')
    <script>
        ...
        $("#saveForm textarea[name='content']").ckeditor({
            height: '200px'
        });
        ...
        $("#saveForm").validate({
            ...
            submitHandler: function(form){
                ...
                $("#saveForm textarea[name='content']").val(CKEDITOR.instances.content.getData());
                fdata.append("content", $("#saveForm textarea[name='content']").val());
