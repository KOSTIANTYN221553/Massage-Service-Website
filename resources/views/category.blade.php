...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="flip-3d">
                <figure>
                    <img onerror = "noExitImg(this)" src="{{ asset('assets/images/cart/default/saree1.jpg') }}" alt="product image">
                    <figcaption>
            ...
            <div class="flip-3d">
                <figure>
                    <img onerror = "noExitImg(this)" src="{{ asset('assets/images/cart/default/saree3.jpg') }}" alt="product image">
                    <figcaption>
                        <h4 class="text-white">Floral Printed Saree</h4>
                        <ul class="text-white">
                            <li>Product Type - Women's Saree</li>
            ...
            <div class="flip-3d">
                <figure>
                    <img onerror = "noExitImg(this)" src="{{ asset('assets/images/cart/default/saree4.jpg') }}" alt="product image">
                    <figcaption>
                        <h4 class="text-white">Floral Printed Saree</h4>
                        <ul class="text-white">
                            <li>Product Type - Women's Saree</li>
            ...
            <div class="flip-3d">
                <figure>
                    <img onerror = "noExitImg(this)" src="{{ asset('assets/images/cart/default/saree5.jpg') }}" alt="product image">
                    <figcaption>
                        <h4 class="text-white">Floral Printed Saree</h4>
                        <ul class="text-white">
                            <li>Product Type - Women's Saree</li>
        ...
        <div class="row">
            ...
            <div class="flip-3d">
                <figure>
                    <img onerror = "noExitImg(this)" src="{{ asset('assets/images/cart/default/saree6.jpg') }}" alt="product image">
                    <figcaption>
                        <h4 class="text-white">Floral Printed Saree</h4>
                        <ul class="text-white">
                            <li>Product Type - Women's Saree</li>
            ...
            <div class="flip-3d">
                <figure>
                    <img onerror = "noExitImg(this)" src="{{ asset('assets/images/cart/default/saree7.jpg') }}" alt="product image">
                    <figcaption>
                        <h4 class="text-white">Floral Printed Saree</h4>
                        <ul class="text-white">
                            <li>Product Type - Women's Saree</li>
