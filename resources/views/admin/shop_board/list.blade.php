            ...
            <div class="col-lg-12">
                <div class="panel panel-primary filterable">
                    ...
                    <div class="panel-body ">
                        <form id = "searchFrm" action = "{{url("admin/shop_board")}}" method = "post">
                                ...
                                @foreach($list as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class = "btn btn-danger" href = "{{url("admin/shop_board/info/".$item['id'])}}">{{__('lang.수정')}}</a>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
                        ...
                        <div class = "table-responsive">
                            <div class = "col-md-12 text-left">
                                ...
                                @if($user['type']*1 == 70)
                                <a type = "button" class = "btn btn-primary float-right" href = "{{url('admin/shop_board/info/0')}}"><i class = "fa fa-plus"></i>{{__('lang.글쓰기')}}</a>
                                @endif
                            </div>
                        </div>
                    </div>
...
@section('footer_scripts')
    <script type="text/javascript" src="{{ asset('assets/js/pages/admin/shop_board.js') }}" ></script>
    <script>
        function viewDetail(obj){
            var id = $(obj).attr("data-id");
            var url = "{{url('admin/shop_board/view')}}/"+id;
            loading_start();
