            ...
            <div class="col-lg-12">
                <div class="panel panel-primary filterable">
                    ...
                    <div class="panel-body ">
                        <form id = "searchFrm" action = "{{url("admin/shop_type")}}" method = "post">
                            ...
                            <table class="table table-bordered table-striped  table-hover">
                                ...
                                @foreach($list as $key => $item)
                                    <tr>
                                        ...
                                        <td>{{$item['title']}}</td>
                                        <td>
                                            <a class = "btn btn-danger" href = "{{url("admin/shop_type/info/".$item['id'])}}">{{__('lang.수정')}}</a>
                                        </td>
                                    </tr>
                                @endforeach
                                @if(count($list) == 0)
                        ...
                        <div class = "table-responsive">
                            <div class = "col-md-12 text-left">
                                ...
                                <a type = "button" class = "btn btn-primary float-right" href = "{{url('admin/shop_type/info/0')}}"><i class = "fa fa-plus"></i>{{__('lang.업소종류생성')}}</a>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('footer_scripts')
    <script type="text/javascript" src="{{ asset('assets/js/pages/admin/shop_type.js') }}" ></script>
    <script>
        $(function(){
           @if(isset($notice_info))
