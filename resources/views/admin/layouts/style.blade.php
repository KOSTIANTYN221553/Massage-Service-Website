...
<link rel="stylesheet" type="text/css" href="{{ url('assets/datepicker/datepicker.css') }}" />
...
<link href="{{url('assets/mobiscroll/css/mobiscroll/mobiscroll.custom-2.17.1.min.css')}}" rel="stylesheet" type="text/css">
