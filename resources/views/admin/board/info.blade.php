            ...
            <div class="col-md-12">
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form  id = "infoForm" action = "{{url("admin/board/ajaxSaveInfo")}}" method = "post">
                            ...
                            <div class="form-group">
                                <label class="control-label" for="name">{{__('lang.타입')}}</label>
                                <select class = "form-control" name = "board_type">
                                    @foreach($board_type_list as $key => $board)
                                        <option value = "{{$key}}" @if($key *1 == $info['board_type']*1 ) selected @endif>{{$board}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="form-group">
