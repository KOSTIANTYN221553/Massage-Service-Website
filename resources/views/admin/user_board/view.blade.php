                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                                ...
                                @foreach($reply_list as $reply)
                                    <li class="media">
                                        <div class="media-body">
                                            ...
                                            <form class = "reply_form hidden" method = "method" action="{{url("admin/user_board/ajaxSaveReply")}}" accept-charset="UTF-8" class="bf" enctype="multipart/form-data">
                                        ...
                                        <div class = "reply_reply_form-rect hidden">
                                            <form class = "reply_reply_form" method = "post" action = "{{url('admin/user_board/ajaxSaveReply')}}" accept-charset="UTF-8" class="bf" enctype="multipart/form-data">
                        ...
                        <div class = "comment-write-rect">
                            <h3>댓글쓰기</h3>
                            <form method="POST" id = "replyForm" action="{{url("admin/user_board/ajaxSaveReply")}}" accept-charset="UTF-8" class="bf" enctype="multipart/form-data">
                                <input type = "hidden" name = "board_id" value = "{{$info['id']}}"/>
...
<script>
    function deleteReply(obj){
        confirmMsg("{{__('lang.정말 삭제하겟습니까?')}}", function(){
           ...
           param._token = _token;
           param.id = id;
           var url = "{{url("admin/user_board/deleteReply")}}";
           loading_start();
