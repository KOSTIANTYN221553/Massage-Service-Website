...
{{-- Page title --}}
@section('title')
    @if($id*1 == 0) {{__('lang.이비자갤러리등록')}} @else {{__('lang.이비자갤러리수정')}} @endif
    @parent
@stop
...
@section('content')
    ...
    <section class="content-header">
        <h1>@if($id*1 == 0) {{__('lang.이비자갤러리등록')}} @else {{__('lang.이비자갤러리수정')}} @endif</h1>
    </section>
    <!--section ends-->
            ...
            <div class="col-md-12">
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form  id = "infoForm" action = "{{url("admin/ebza_board/ajaxSaveInfo")}}" method = "post">
                    ...
                    success: function (data) {
                        if (data.status == '1') {
                            successMsg("{{__('lang.수정이 성공하였습니다.')}}", function(){
                               ...
                               if(id == "0"){
                                   window.location.href = "{{url('admin/ebza_board')}}";
                               }else{
                                   goBack();
                               }
