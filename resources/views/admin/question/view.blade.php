                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="control-label">{{__('lang.타입')}}:</label>
                            <label class="control-label">{{getBoardTypeStr($info['board_type'])}}</label>
                        </div>
                        <div class="form-group">
                                ...
                                @foreach($reply_list as $reply)
                                    <li class="media">
                                        <div class="media-body">
                                            ...
                                            <form class = "reply_form hidden" method = "method" action="{{url("admin/question/ajaxSaveReply")}}" accept-charset="UTF-8" class="bf" enctype="multipart/form-data">
...
<script>
    ...
    function deleteReply(obj){
        confirmMsg("{{__('lang.정말 삭제하겟습니까?')}}", function(){
           ...
           param._token = _token;
           param.id = id;
           var url = "{{url("admin/question/deleteReply")}}";
           loading_start();
