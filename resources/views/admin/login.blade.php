        ...
        <div class=" col-xs-10 col-xs-offset-1 col-sm-6 col-sm-offset-3  col-md-5 col-md-offset-4 col-lg-4 col-lg-offset-4">
            <div class="panel panel-default">
                <div class="panel-heading hidden">
                    <h3 class="panel-title text-center">{{__('lang.관리자페이지')}}</h3>
                </div>
                <div class="panel-body">
                    <form action="{{ route('signin') }}" id="authentication" autocomplete="on" method="post" role="form">
                        ...
                        <div class="form-group pt-20 {{ $errors->first('email', 'has-error') }}">
...
<script src="{{url('assets/mobiscroll/js/mobiscroll/jquery-1.11.1.min.js')}}" type="text/javascript"></script>
<!-- global js -->
...
<script src="{{ url('assets/js/pages/admin/common.js') }}"></script>
